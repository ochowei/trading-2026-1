...
| `docs/workflow-governance-layers.html` | Consolidated standalone governance atlas: A1 inter-layer handoffs, A2 internal lifecycles, B1 authority sequence, and B2 lifecycle activity for workflow design, release authority, and study review. |
