<!-- AI_CONTEXT_START - 此區塊供 AI Agent 快速讀取，人工更新
  ...
  phase9_note_2026_08_06: GLD-015 and GLD-017 now consume declared GVZ and GVZ/UUP historical auxiliary bundles through the provider-free execution boundary; migration runs remain migration-pending and do not advance latest or followup qualification.
  phase9_note_2026_08_06_primary_wave: GLD-001 through GLD-014 now use the shared primary-only verified bundle boundary; migration runs remain pending and do not advance latest or followup qualification.
...
| GLD-015 | `gld_015_gvz_implied_vol_mr` | GVZ Implied-Vol Forward-Looking Regime-Gated MR（Att2 SUCCESS）| 同 GLD-014 Att2 + **^GVZ 10d change <= +0.40**, TP +3.0%, SL -4.0%, 20d | ✅ 前最佳；Phase 9 auxiliary bundle，migration-pending |
...
| GLD-017 | `gld_017_usd_regime_mr` | GLD–USD Cross-Asset Divergence Regime-Gated MR（documented failure，superseded by GLD-016）| 同 GLD-015 Att2 + **UUP 20d 報酬 CEILING <= +3.0%**, TP +3.0%, SL -4.0%, 20d | ❌ 未超越 GLD-016；Phase 9 auxiliary bundle，migration-pending |
