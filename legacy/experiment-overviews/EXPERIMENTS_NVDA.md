<!-- AI_CONTEXT_START - 此區塊供 AI Agent 快速讀取
  ...
  note_2026_08_06_phase9: NVDA-006, NVDA-008, NVDA-014, and NVDA-015 now consume declared SMH/SPY historical auxiliary bundles through the shared provider-free execution boundary; migration-pending only, with no latest publication or qualification change.
  note_2026_08_06_phase9_direct_wave: NVDA-018 now declares ^VXN and NVDA-021 declares QQQ through the same provider-free auxiliary boundary; both migrations remain migration-pending with no latest publication or qualification change.
  note_2026_08_06_phase9_legacy_wave: NVDA-016 now consumes its declared SMH historical auxiliary bundle through the same provider-free boundary; the migration run remains migration-pending with no latest publication or qualification change.
  note_2026_08_07_phase9_primary: NVDA-001 through NVDA-005, NVDA-009 through NVDA-013, and NVDA-017/019/020 now consume declared primary NVDA bundles through the provider-free execution boundary; migration runs remain migration-pending with no latest publication or qualification change.
  evidence_2026_08_07_phase9_primary: The primary-only migration is contract-covered; no new fixed snapshot or latest result was created, and existing experiment outcomes remain unchanged pending parity/requalification.
...
| NVDA-006 | `nvda_006_relative_strength` | 相對強度：NVDA-SMH RS≥5% + 5日回撤3-8% + SMA(50)，TP+8%/SL-7%/20天 | 已完成（互補策略，min(A,B) 持平，OOS +36%；Phase 9 auxiliary bundle，migration-pending） |
| NVDA-007 | `nvda_007_rs_exit_optimized` | RS 出場優化：同 NVDA-006 進場，3種出場嘗試（25d/SL-8%/15d） | 已完成（3次嘗試均未超越 NVDA-006） |
| NVDA-008 | `nvda_008_rs_param_explore` | RS 參數探索：10日/40日回看、SPY基準（3次嘗試均未超越） | 已完成（3次嘗試均未超越 NVDA-004/006；Phase 9 auxiliary bundle，migration-pending） |
