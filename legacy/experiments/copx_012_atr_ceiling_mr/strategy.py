...
class COPX012Strategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """COPX-012：波動率加速雙向過濾均值回歸（含成交模型）"""

    slippage_pct: float = 0.0015  # 0.15% 商品 ETF 滑價（同 COPX-007）

    bundle_trial_family = "COPX:atr-ceiling-mr"
    bundle_trial_hypothesis = (
        "COPX ATR-ceiling mean reversion can be reproduced from a verified primary bundle."
    )
