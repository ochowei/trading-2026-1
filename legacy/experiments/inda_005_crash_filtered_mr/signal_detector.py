...
from trading.experiments.inda_005_crash_filtered_mr.config import INDA005Config

logger = logging.getLogger(__name__)


class INDA005SignalDetector(BaseSignalDetector):
    def __init__(self, config: INDA005Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("INDA-005: Detected %d crash-filtered MR signals", signal_count)
        return df
