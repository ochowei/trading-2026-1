...
- 空遠端 artifact `sivr_019_gvz_direction_mr` 為 branch-divergence artifact
  ...
  `sivr_020_usd_regime_mr` 建立，並直接移植 GLD-016 已驗證之 UUP regime
...
@dataclass
class SIVR020Config(ExperimentConfig):
    """SIVR-020 SIVR–USD Cross-Asset Divergence Regime-Gated MR 參數
...
def create_default_config() -> SIVR020Config:
    return SIVR020Config(
        name="sivr_020_usd_regime_mr",
        experiment_id="SIVR-020",
