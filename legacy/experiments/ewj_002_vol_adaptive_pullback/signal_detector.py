...
from trading.experiments.ewj_002_vol_adaptive_pullback.config import EWJ002Config

logger = logging.getLogger(__name__)


class EWJ002SignalDetector(BaseSignalDetector):
    def __init__(self, config: EWJ002Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EWJ-002: Detected %d vol-adaptive pullback signals", signal_count)
        return df
