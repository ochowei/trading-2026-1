"""
EEM-001 訊號偵測器：RSI(2) 極端超賣均值回歸
(EEM-001 Signal Detector: RSI(2) Extreme Oversold Mean Reversion)
...
class EEMRsi2MeanReversionSignalDetector(BaseSignalDetector):
    def __init__(self, config: EEMRsi2MeanReversionConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EEM-001: Detected %d RSI(2) extreme oversold signals", signal_count)
        return df
