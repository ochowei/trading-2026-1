"""
EEM-003 訊號偵測器：波動率自適應 RSI(2) + 長冷卻期
...
from trading.experiments.eem_003_vol_adaptive_deep_decline.config import EEM003Config

logger = logging.getLogger(__name__)


class EEM003SignalDetector(BaseSignalDetector):
    def __init__(self, config: EEM003Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EEM-003: Detected %d vol-adaptive deep decline signals", signal_count)
        return df
