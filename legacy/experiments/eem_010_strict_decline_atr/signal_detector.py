"""
EEM-010 訊號偵測器：嚴格跌幅 + ATR 波動率自適應 RSI(2)
...
from trading.experiments.eem_010_strict_decline_atr.config import EEM010Config

logger = logging.getLogger(__name__)


class EEM010SignalDetector(BaseSignalDetector):
    def __init__(self, config: EEM010Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EEM-010: Detected %d strict-decline ATR signals", signal_count)
        return df
