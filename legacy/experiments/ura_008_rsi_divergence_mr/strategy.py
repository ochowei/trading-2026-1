...
class URARSIDivergenceMRStrategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """URA-008：RSI(14) bullish hook + URA-002 回檔+WR 均值回歸"""

    slippage_pct: float = 0.0010

    bundle_trial_family = "URA:rsi-divergence-mr"
    bundle_trial_hypothesis = (
        "URA RSI divergence mean reversion can be reproduced from a verified primary bundle."
    )
