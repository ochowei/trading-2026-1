"""
VGK-002 訊號偵測器：波動率自適應 RSI(2) 均值回歸
(VGK-002 Signal Detector: Volatility-Adaptive RSI(2) Mean Reversion)
...
class VGK002SignalDetector(BaseSignalDetector):
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("VGK-002: Detected %d vol-adaptive RSI(2) signals", signal_count)
        return df
