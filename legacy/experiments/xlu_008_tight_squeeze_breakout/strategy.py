...
class XLU008TightSqueezeStrategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """XLU-008：Tight BB Squeeze Breakout 策略（含成交模型）"""

    slippage_pct: float = 0.001

    bundle_trial_family = "XLU:tight-squeeze-breakout"
    bundle_trial_hypothesis = (
        "XLU tight squeeze breakouts can be reproduced from a verified primary bundle."
    )
