"""
DIA QQQ Macro-Confirmation Gate MR 配置 (DIA-019)
...
策略方向（Strategy Direction）：
    ...
    小型股急殺）。DIA-019 為「QQQ macro-confirmation gate 是否能由小型股
...
@dataclass
class DIA019Config(ExperimentConfig):
    """DIA-019 QQQ Macro-Confirmation Gate MR 參數"""
    ...
    # ── DIA-019 新增：QQQ 跨資產宏觀確認閘門（移植 IWM-015）──
...
def create_default_config() -> DIA019Config:
    return DIA019Config(
        name="dia_019_qqq_macro_confirm_mr",
        experiment_id="DIA-019",
