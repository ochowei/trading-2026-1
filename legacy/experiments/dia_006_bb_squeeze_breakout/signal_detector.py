"""
DIA-006 訊號偵測器：Bollinger Band Squeeze Breakout
DIA-006 Signal Detector: BB Squeeze Breakout
...
from trading.experiments.dia_006_bb_squeeze_breakout.config import DIA006BBSqueezeConfig

logger = logging.getLogger(__name__)


class DIA006BBSqueezeDetector(BaseSignalDetector):
    """DIA BB Squeeze Breakout 訊號偵測器"""

    def __init__(self, config: DIA006BBSqueezeConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("DIA-006: Detected %d BB squeeze breakout signals", signal_count)
        return df
