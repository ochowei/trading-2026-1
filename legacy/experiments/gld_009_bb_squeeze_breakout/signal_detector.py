"""
GLD-009 訊號偵測器：BB Squeeze Breakout
GLD-009 Signal Detector: BB Squeeze Breakout
...
from trading.experiments.gld_009_bb_squeeze_breakout.config import GLD009Config

logger = logging.getLogger(__name__)


class GLD009SignalDetector(BaseSignalDetector):
    """GLD BB Squeeze Breakout 訊號偵測器"""

    def __init__(self, config: GLD009Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("GLD: Detected %d BB squeeze breakout signals", signal_count)
        return df
