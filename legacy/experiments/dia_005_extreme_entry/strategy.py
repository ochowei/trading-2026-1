...
class DIAExtendedHoldStrategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """DIA RSI(2) 延長持倉均值回歸 (DIA-005)"""

    bundle_trial_family = "DIA:extreme-entry"
    bundle_trial_hypothesis = (
        "DIA extreme-entry reversal can be reproduced from a verified primary bundle."
    )
