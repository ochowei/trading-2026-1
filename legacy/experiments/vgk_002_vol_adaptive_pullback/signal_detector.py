...
from trading.experiments.vgk_002_vol_adaptive_pullback.config import VGK002Config
...
class VGK002SignalDetector(BaseSignalDetector):
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("VGK-002: Detected %d vol-adaptive pullback signals", signal_count)
        return df
