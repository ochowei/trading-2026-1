...
from trading.experiments.ewt_003_bb_squeeze_breakout.config import EWT003Config

logger = logging.getLogger(__name__)


class EWT003SignalDetector(BaseSignalDetector):
    def __init__(self, config: EWT003Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EWT-003: Detected %d BB squeeze breakout signals", signal_count)
        return df
