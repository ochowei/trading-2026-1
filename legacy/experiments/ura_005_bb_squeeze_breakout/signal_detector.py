"""
URA-005 訊號偵測器：BB Squeeze Breakout
URA-005 Signal Detector: BB Squeeze Breakout
...
class URABBSqueezeBreakoutDetector(BaseSignalDetector):
    """URA BB Squeeze Breakout 訊號偵測器"""

    def __init__(self, config: URABBSqueezeBreakoutConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("URA: Detected %d BB squeeze breakout signals", signal_count)
        return df
