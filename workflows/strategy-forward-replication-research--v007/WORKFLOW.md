...
| `docs/historical-qualification-and-shadow-v007.md` | normative | Clean/retrospective plan、explicit role calendars、frozen selection boundaries、folds/gates、benchmarks、selection adjustment、Shadow registration 與 activation eligibility。 |
