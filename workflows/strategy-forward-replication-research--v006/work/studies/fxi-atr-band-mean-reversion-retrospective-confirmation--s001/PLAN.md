...
- Study: `strategy-forward-replication-research@v006/S001` at
...
- Workflow: `strategy-forward-replication-research@v006` at
...
- Workflow `RELEASE.json` SHA-256:
  `f58d60322e8a975c7d2c73bcf22fbe947f31806d35cbc5d363b593e0036e0a10`.
- Workflow definition SHA-256:
  `6b786b506d49a3e02dd88b63171e3697f74be1084ece2764d8c0123dafe78af8`.
- Canonical source Git HEAD at draft preparation:
  `3b1a50f0569de68dca6838e5f0ff728e0a8a0b25`.
...
The cancelled v005/S001 and S004 candidate-freeze approvals are lineage evidence only. They are not
approval to preregister this study, inspect 2010-2014 outcomes, or freeze a v006 retrospective
candidate. v005/S001 registered no qualification plan and exposed no 2010-2014 outcome; it was cancelled only
to restart under v006's explicit role-calendar contract. This successor remains `draft` until the
owner reviews the complete frozen summary and separately approves preregistration. Outcome-relevant
execution requires another later authorization after a new candidate-freeze record.
...
qualification plan, manifest, observation, and screen must bind this exact v006 release and policy
set.
...
| --- | --- |
| Warmup only | All required 2009 XNYS observations; no signal, fill, cooldown, position, P&L, capital, or performance contribution |
| Retrospective confirmatory | Complete XNYS inventories for five consecutive annual folds: 2010, 2011, 2012, 2013, 2014; fold-local opening embargo remains inside this inventory |
...
Six permanent source entry points are already tracked and formally registered under
...
The existing append-only trial registrations are inherited identities, not inherited approval.
The registry was rechecked on 2026-08-13: all six are `registered` with zero observations. The
v005 definition snapshots below are provenance records only; a later, separately authorized v006
candidate freeze must capture and approve the exact current snapshots again.

| Stable identity | Trial ID | Definition fingerprint | v005 snapshot ID |
| --- | --- | --- | --- |
| `atr-band-candidate` | `697276adf91be9547c38d9197277c97b2c6fdfdb97b2d4c4975e2f325632e674` | `6aa709255f84591960793dc744cbdfaaf3d6652ef9287581a89ace4765521456` | `c1fd7a38dbf1fe93ca99e1e2ae96ba8fccee9d90bac9a6612ec44540be9a17dc` |
| `atr-ceiling-1p30-robustness` | `059dc99759003284f0df05cbf092c6464eaa6128a0e5468150b169fc8e95b603` | `bde92ea6f397995474b67cb9bdaa4b10ccd7c9c50cfdbaee101abf51e91a5537` | `04913f7e089455953b573b095b3ba16448d8a0919d02661062a6c05acb2775af` |
| `atr-floor-1p10-robustness` | `fac88cfbaf5068fff2795699fd7f3be10534bcec95c6c0d7f03b3aab91e99ba9` | `48f8b547c1f005e2c2567ce47223c7053ecdcfb2dddabcb952c050e1fae52b96` | `f08da3546b1e107ec9ed8339a3fb3526418869f8ecf0fb63e1d94748fbdecf67` |
| `delay-one-session-robustness` | `651f6fa0a12c88b6d45a0ec6b55d917a5a239f38ac1371da9a67e9fe3b71a504` | `a3c49c75fb63cdfc7bcd833a98e3fd26167edec66126d8c0192edee1b5dabb78` | `c8c1a80b38d8e8c06ecdbb5bface45a5bcc5e72c207a1f9c66aec2000c23ef9e` |
| `hold-18-robustness` | `ac5b1d5ec5e4db18d69a1a743449d69888a00d4c4c6fc6b57e0230fbfe04f145` | `a066f0e1baf3ace49602e079895a6e74e3923a0f7304ce6befd45fd67649ecd9` | `c8632fec3f4ecafb8626dea5a41809e3f2ee0dceadbfc7cf6740a620cea3ec19` |
| `pullback-wr-baseline` | `c3c04fd0bcb59ca8ecb250d8fd37e1ed68caa13233c1656d1be3381254918e8c` | `5bfdf7456f4c92a5114601bc2ee388a2e9f52ebea4e4701aa41b352e1adca433` | `7fdd20340d74031ac0dc10d4981b7a9b5667482bae7821c48ba22e21d974c696` |

The v005 candidate-freeze record observed the trial registry at SHA-256
`beabc8dfc2ee33e0e628760d8b111bc4ab0a4507e02ef571e01e0a77dc50973a`.
That hash is historical lineage evidence and is not a pin of mutable current registry bytes.

Frozen source-byte inventory reconfirmed for successor owner review:
...
Frozen explicit-role-calendar orchestration inventory:

| Maintained source / test | SHA-256 |
| --- | --- |
| `src/trading/cli.py` | `31745c12ca1c7a152e14cd406267d7867e3a77b6805e290c5ee1b766b08542a6` |
| `src/trading/core/qualification.py` | `bd3f820b42e1ce34cf6efa681e54b5f34d8be1014c7a04584b06d7d9d2b75762` |
| `src/trading/core/qualification_workflow.py` | `f7979d765aaafd7fd5ff616abb25e58929558c69fdb52ac56bf8b615aa82d815` |
| `src/trading/research_data/qualification_registry.py` | `f37b017e3a003df344788adaeec0dd0d62bc3903a4954ec810f6b5bdc7b3bc0a` |
| `src/trading/research_data/result_schema.py` | `7e0417b6e74a70f6ee4b00c9b10d2c5f12350b75c82ae578fef4cb869027a0de` |
| `tests/test_historical_qualification.py` | `c90a9d024e1734a56a377e07a19956529a97e9ddbf3a301bbb5bf639dc96b3c7` |
| `tests/test_qualification_workflow.py` | `c9642e61c12880c72b034181295f716b8f1ae05f3fc2de0577aeb507b341a9a8` |
| `tests/test_qualification_cli.py` | `6bf618104055643a6f52093f4f4b7efa2d8cf1996d78bb5d3907abc3150825ca` |
| `tests/test_qualification_registry.py` | `a81f96410c766713bebad584a6cea48e7784043b91d8497ce2ee043c873889f5` |
| `tests/test_result_schema.py` | `9e17f8ae4f3c2176013720bbd03ab3f9fd44f665ab6470272df76bf54c40601b` |

The provider-free test suite continues to verify all six registry identities, the primary-only
dependency,
...
and Research Definition Snapshot capture against the exact v006 policy set. Refresh, snapshot,
...
registration, the v006 owner must create a new candidate-freeze record that pins all six source
...
While status is `draft`, keep the six existing provider-free source identities and synthetic tests
...
After preregistration, obtain separate explicit authorization to prepare and approve a new v006
candidate freeze. Verify all six source fingerprints and the complete family without market
outcomes. Then register exactly one `retrospective-confirmatory` qualification plan for 2010-2014 with
explicit Development/warmup/Evaluation role inventories, with `provenance-unknown` (or stricter
`known-contaminated` if the audit requires), complete new-
...
seed 20260813, 1,000 random samples, 1,000 bootstrap repetitions, and 20-session blocks. The
guarded registration must pass `--development-years 2015 ... 2025`, `--warmup-start 2009-01-01`,
and `--warmup-end 2009-12-31`; generated XNYS inventories must match the preregistered roles,
remain pairwise disjoint, and keep Development sessions out of screen returns.
...
Outcome interpretation under v006:
