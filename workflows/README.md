...
Use the repository skill `trading-author-workflow` to review, create, or evolve a workflow. Use
`uv run trading workflow validate --all` for deterministic validation and
