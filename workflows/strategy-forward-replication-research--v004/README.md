...
| --- | --- | --- | --- | --- |
| `S004` | FXI ATR-Band Mean-Reversion Forward Replication | `paused` | `-` | [fxi-atr-band-mean-reversion-forward-replication--s004](work/studies/fxi-atr-band-mean-reversion-forward-replication--s004/) |
