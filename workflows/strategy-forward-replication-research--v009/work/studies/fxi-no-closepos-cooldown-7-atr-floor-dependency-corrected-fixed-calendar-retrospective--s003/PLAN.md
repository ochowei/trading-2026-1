...
- Revisited study:
  `workflows/strategy-forward-replication-research--v009/work/studies/fxi-no-closepos-cooldown-7-atr-floor-fixed-calendar-retrospective--s002`.
...
- Execution dependencies: strategy holding rule 20 complete post-entry sessions, qualification
  maximum entry-to-exit span 21 sessions, execution lag 1, signal-to-outcome dependency window
  22, embargo 1, and stress drawdown limit 20%.
...
must not refresh data, create snapshots, execute a definition, inspect new outcomes, or mutate a
registry.

Show the complete frozen claim, plan, S001/S002-informed contamination disclosure, and qualification
...
Obtain a separate Development-only authorization. Reverify and reuse the six immutable S002
Development snapshots and formal offline observations, because S003 changes no definition,
calendar role, policy, cost, gate, or selection rule. Bind their exact checksums and the complete
S002 ranking into a new S003 Development gate; do not execute definitions again or substitute a
new observation. Preserve all six observations, failures, trial identities, fingerprints, the
complete ranking, and the exact eligibility decision.
...
Obtain separate narrow Evaluation authority. Reverify and reuse the six immutable S002 Evaluation
snapshots and formal offline observations over the fixed 2020-2024 role inventory, because their
definitions, role projection, policy set, costs, and data generation are unchanged. Bind their
exact checksums to the new S003 plan; do not execute definitions again or substitute a new
observation. Warmup may supply only declared dependencies; Development, quarantine, and replay
