...
| TSM | TSM-007 | 相對強度動量回調 (RS Momentum Pullback) | ~2.4/5.0 | 75.0%/90.0% | TSM-SMH 20日報酬差≥5% + 5日回撤3-7% + Close>SMA(50)，TP+7%/SL-7%/20天/冷卻10天。Part A Sharpe 0.64/Part B 1.32（vs TSM-006 動量回調 0.46/0.57，+39%/+132%），min(A,B) 0.64。**相對強度首次超越絕對動量**，過濾純板塊 beta 上漲聚焦 TSM alpha。RS 5% 為甜蜜點（3% 過鬆 min 0.44、8% 過嚴 min -0.01）。TSM-007 三次嘗試：Att1 RS5% min 0.64、Att2 RS8% min -0.01、Att3 RS3% min 0.44（7 次實驗、21 次嘗試，含均值回歸、突破、動量回調、相對強度四大策略類型） |
