...
## 6. 確認指標的邊際效益遞減
<!-- freshness:
  derived_from: [TQQQ-007,TQQQ-012,TQQQ-013,USO-006,USO-010~020,TSM-004,FCX-003,SIVR-006,SIVR-007,IWM-005,XBI-005,FXI-011,INDA-009,EEM-013,TLT-010]
...
| TLT | TLT-007 Att2 | 回檔+WR+反轉K線+**BB 寬度 regime 閘門**（<5%）| 0.12/0.65 | 10 次實驗 ✓（TLT-010 2DD/ATR 補充濾波三次失敗，signal-day secondary filter 結構性不適用）|
...
## 19. 2日急跌過濾（雙向性發現 2026-04-21，VGK-008 再確認「懸崖式」vs「漸進式」特性 2026-04-22）
<!-- freshness:
  derived_from: [FCX-008,USO-013,EWT-004,VGK-005,CIBR-012,EEM-014,INDA-010,VGK-008]
