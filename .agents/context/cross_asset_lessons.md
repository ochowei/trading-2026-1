...
28. **BB 擠壓突破在分散化/商品/利率/3x 槓桿 ETF** — 有效性：個股(2-4%) > 高流動 ETF(1.5-2%) > 其餘均失敗
...
<!-- freshness:
  derived_from: [XBI-009,XBI-002,COPX-006,SPY,DIA,IWM]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: high
-->

- **寬基指數 ETF（SPY/DIA/IWM/VOO）**：RSI(2) 短期超賣框架最佳
...
## 18. BB 擠壓突破有效性排序
<!-- freshness:
  derived_from: [TSLA-005,NVDA-003,FCX-004,IWM-006,COPX-005,SOXL-009,GLD-009,SIVR-008,TLT-004,IBIT-003,TSM-005]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: high
-->
