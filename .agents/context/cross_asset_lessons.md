...
| FXI | FXI-003 Att3 | 回檔+WR+ClosePos | 0.07 | 3 次實驗（初步探索） |
...
<!-- freshness:
  derived_from: [XBI-009,XBI-002,COPX-006,SPY,DIA,IWM,EEM-005]
...
- **新興市場 ETF（EEM）**：BB 擠壓突破最佳（EM risk-on/risk-off 資金流驅動突破），均值回歸受 EM 事件拖累
