...
| URA | URA-012 Att2 | 回檔+RSI(2)+2DD+**ATR(5)/ATR(20) BAND [1.00, 1.50]**（lesson #15 v3 鏡像 BAND） | 0.47† | 12 次實驗 ✓（**repo 首次 Part A/B SLs ATR 鏡像分布結構發現 / 首次 lesson #15 BAND-required 資產**）|
