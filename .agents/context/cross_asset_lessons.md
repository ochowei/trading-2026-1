...
<!-- freshness:
  derived_from: [USO-005, USO-007, USO-009, USO-010, SPY-004, SIVR-004]
  validated: 2026-03-29
  data_through: 2025-12-31
  confidence: high
-->
...
**例外**：SIVR 雖平均持倉 4-7 天，但 RSI(2) 替換 WR(10) 後 Part B 反而下降 38%。高波動資產（SIVR 日波動 ~2-3%）中 RSI(2) 過於敏感，訊號日期偏移 1-3 天可能從達標變停損。WR(10) 的寬視角反而在高波動環境提供更穩定判斷。
