...
<!-- freshness:
  derived_from: [TQQQ-010, TQQQ-015, GLD-007, GLD-008, GLD-009, GLD-010, SIVR-001, SIVR-003, SIVR-005, SIVR-006, SIVR-007, SIVR-008, SIVR-009, SIVR-010, FCX-001, FCX-002, FCX-003, FCX-004, FCX-005, FCX-006, USO-001, USO-002, USO-003, USO-004, USO-012, USO-013, USO-015, USO-016, USO-017, USO-018, USO-019, USO-020, SPY-005, SPY-006, SPY-007, SPY-008, DIA-001, DIA-006, DIA-007, DIA-008, DIA-009, SOXL-001, SOXL-002, SOXL-003, SOXL-005, SOXL-006, SOXL-007, SOXL-008, TSM-004, TSM-005, TSM-006, TSM-007, TSM-008, TSM-009, VOO-003, IWM-001, IWM-002, IWM-003, IWM-004, IWM-005, IWM-006, IWM-007, IWM-008, IWM-009, IWM-010, XBI-001, XBI-002-failed, XBI-003-failed, XBI-005, XBI-006, XBI-007, COPX-001, COPX-002, COPX-003, COPX-004, COPX-005, COPX-006, URA-001, URA-002, URA-003, URA-004, URA-005, URA-006, IBIT-001, IBIT-002, IBIT-003, NVDA-002, NVDA-003, NVDA-004, NVDA-005, NVDA-007, TLT-001, TLT-002, TLT-004, TLT-005, TSLA-003, TSLA-004, TSLA-005, TSLA-006, TSLA-007, TSLA-008, XLU-002, XLU-003, XLU-004, XLU-005, XLU-006, XLU-007]
...
| TSLA | TSLA-005 | BB 擠壓突破 | ~3.2/2.5 | 56.2%/60.0% | BB(20,2) 擠壓（60日 25th 百分位，5日內）+ Close > Upper BB + Close > SMA(50)，TP+10%/SL-7%/20天。Part A Sharpe 0.35/Part B 0.37（A/B gap 0.02，極佳平衡）。**突破策略首次超越均值回歸**（vs TSLA-004 Sharpe 0.14/0.13，+150%/+185%）。WR 較低但盈虧比補償（PF 2.04/2.10）。TSLA 動量驅動，順勢突破優於逆勢均值回歸。TSLA-006 驗證趨勢回調（Part B 0.22/-0.02）和 Donchian 突破（Part B 0.07）均失敗，TSLA-007 驗證 Keltner Channel 突破（3 次嘗試，最佳 Part A 0.10/Part B 0.53，ATR-based 不如 BB 標準差）均失敗，TSLA-008 驗證 RS 動量回調（QQQ/XLY 參考，2 次嘗試，最佳 Part A 0.17/Part B -0.96，事件驅動超額表現不具持續性）和 BB Squeeze 金叉（SMA(20)>SMA(50)，min 0.37 邊際優於 0.35 但 A/B gap 0.39）均失敗，**已確認為全域最優**（8 次實驗、28+ 次嘗試，含均值回歸、BB 突破、趨勢回調、Donchian 突破、Keltner Channel 突破、RS 動量回調、BB Squeeze 金叉七種策略類型） |
