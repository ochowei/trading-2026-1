...
<!-- freshness:
  derived_from: [TQQQ-010, GLD-007, SIVR-001, SIVR-003, SIVR-005, FCX-001, FCX-002, FCX-003, USO-001, USO-002, USO-003, USO-004, USO-012, USO-013, USO-015, USO-016, USO-017, USO-018, USO-019, USO-020, SPY-002, DIA-001, SOXL-001, SOXL-002, SOXL-003, TSM-004]
  validated: 2026-03-29
  data_through: 2025-12-31
  confidence: high
-->
...
| SOXL | SOXL-003 | 高盈虧比深度超賣 | ~2.6/4.5 | 46.2%/44.4% | 回撤 -25% + TP +18%/SL -12%/20天，盈虧比 1.5:1，Part A +10.86%/Part B +1.79%（首個雙期間正報酬），PF 1.29/1.19，Sharpe 0.13/0.09。SOXL-003 驗證：SL -15% 更差（不減少停損次數）、TP +20% A/B 失衡（硬上限）、TP +18% 是甜蜜點 |
