# Cross-Asset Lessons — Detailed Evidence
...
<!-- freshness:
  derived_from: [TQQQ-010, TQQQ-015, GLD-007, GLD-008, GLD-009, GLD-010, GLD-011, GLD-012, SIVR-001, SIVR-003, SIVR-005, SIVR-006, SIVR-007, SIVR-008, SIVR-009, SIVR-010, SIVR-011, SIVR-012, SIVR-013, SIVR-014, FCX-001, FCX-002, FCX-003, FCX-004, FCX-005, FCX-006, FCX-007, FCX-008, USO-001, USO-002, USO-003, USO-004, USO-012, USO-013, USO-015, USO-016, USO-017, USO-018, USO-019, USO-020, USO-021, SPY-005, SPY-006, SPY-007, SPY-008, DIA-001, DIA-006, DIA-007, DIA-008, DIA-009, DIA-011, SOXL-001, SOXL-002, SOXL-003, SOXL-005, SOXL-006, SOXL-007, SOXL-008, SOXL-009, SOXL-010, SOXL-011, TSM-004, TSM-005, TSM-006, TSM-007, TSM-008, TSM-009, VOO-003, IWM-001, IWM-002, IWM-003, IWM-004, IWM-005, IWM-006, IWM-007, IWM-008, IWM-009, IWM-010, IWM-011, XBI-001, XBI-002-failed, XBI-003-failed, XBI-005, XBI-006, XBI-007, XBI-008, XBI-009, COPX-001, COPX-002, COPX-003, COPX-004, COPX-005, COPX-006, COPX-007, COPX-008, URA-001, URA-002, URA-003, URA-004, URA-005, URA-006, URA-007, IBIT-001, IBIT-002, IBIT-003, IBIT-004, NVDA-002, NVDA-003, NVDA-004, NVDA-005, NVDA-007, NVDA-008, TLT-001, TLT-002, TLT-004, TLT-005, TSLA-003, TSLA-004, TSLA-005, TSLA-006, TSLA-007, TSLA-008, TSLA-009, TSLA-010, TSLA-011, TSLA-012, XLU-002, XLU-003, XLU-004, XLU-005, XLU-006, XLU-007, XLU-008, XLU-009, XLU-010, XLU-011]
...
| SOXL | SOXL-010 Att3 | 板塊 RS 動量回調 | ~1.0/2.0 | 80.0%/75.0% | SOXX-SPY 10日報酬差≥6% + SOXL 5日回調 8-16% + SMA(50)，TP+15%/SL-12%/20天。Part A +40.84%/Sharpe **0.72**，Part B +33.70%/Sharpe **0.70**，PF 4.16/3.72。min(A,B) 0.70（vs SOXL-006 0.47，+49%），A/B gap 0.02（近乎完美）。10日 RS 回看偵測早期板塊動量（20日回看捕捉動量尾端，Att1 Part B 0.11）。SOXL-006（均值回歸，崩盤超賣進場）為累積報酬最優（+72.80%/+51.57%），兩策略互補。SOXL-011 驗證 SOXX ATR 波動率自適應（底層指數 ATR 過濾，2 次嘗試，min 0.34）和 SOXX 趨勢跟蹤回檔（min 0.11，嚴重 A/B 失衡），**已確認為全域最優**（11 次實驗、36 次嘗試，含均值回歸、突破、板塊 RS 動量、底層指數 ATR 過濾、趨勢跟蹤回檔五大策略類型） |
...
| TSLA | TSLA-009 Att2 | BB 擠壓突破（30th pct 優化） | ~3.4/3.0 | 58.8%/66.7% | BB(20,2) 擠壓（60日 **30th** 百分位，5日內）+ Close > Upper BB + Close > SMA(50)，TP+10%/SL-7%/20天，冷卻10天。Part A Sharpe **0.40**/Part B **0.53**（min 0.40，vs TSLA-005 0.35 +14.3%），A/B 年化訊號比 1.13:1（極佳平衡）。30th 百分位（vs 25th）捕捉更多有效擠壓事件。TSLA-009 Att1 驗證 BB(20,2.5) 寬帶無效（Part A 0.22），Att3 驗證冷卻 15→10 天無影響（訊號天然間隔 >15 天）。TSLA-010 驗證 RSI(5) 均值回歸（SOXL-006 框架移植，3 次嘗試），TSLA-011 驗證動量回復/回檔後突破（3 次嘗試），TSLA-012 驗證成交量確認（Att1：Volume>1.3x 移除好訊號，Sharpe 0.22/0.53）、延長擠壓持續（Att2：7日/3日 改變訊號日期，0.35/0.37）、SMA(100)（Att3：讓通假訊號，0.35/0.17），三種過濾方向均嚴格劣化。**已確認為全域最優**（12 次實驗、40 次嘗試，含均值回歸、BB 突破、趨勢回調、Donchian、Keltner、RS 動量、動量回復、成交量確認、擠壓持續、SMA 週期十種策略/過濾方向） |
...
<!-- freshness:
  derived_from: [TQQQ-002, TQQQ-003, TQQQ-005, TQQQ-014, TQQQ-015, GLD-005, GLD-009, SIVR-002, SIVR-003, SIVR-005, SIVR-006, SIVR-007, SIVR-008, SIVR-009, SIVR-010, SIVR-011, SIVR-012, SIVR-013, SIVR-014, SPY-003, SPY-004, SPY-006, DIA-006, DIA-007, DIA-008, DIA-009, DIA-011, USO-002, USO-004, USO-006, USO-007, USO-010, USO-011, USO-012, USO-013, USO-014, USO-015, USO-016, USO-017, USO-018, USO-019, USO-020, USO-021, TSM-004, TSM-005, TSM-009, FCX-003, FCX-004, FCX-005, FCX-006, FCX-007, FCX-008, SOXL-003, SOXL-006, SOXL-007, SOXL-008, SOXL-009, SOXL-011, URA-002, URA-004, URA-005, COPX-003, COPX-005, COPX-006, COPX-007, COPX-008, NVDA-002, NVDA-004, NVDA-005, NVDA-008, IBIT-002, IBIT-004, IWM-004, IWM-005, IWM-006, IWM-007, IWM-009, IWM-010, TLT-002, TLT-004, TLT-005, TSLA-003, TSLA-006, TSLA-007, TSLA-008, TSLA-011, TSLA-012, VOO-003, XBI-005, XBI-006, XBI-007, XBI-008, XBI-009, XLU-002, XLU-003, XLU-004, XLU-005, XLU-006, XLU-007, XLU-008, XLU-009]
  validated: 2026-04-10
  data_through: 2025-12-31
  confidence: high
-->
...
18. **Bollinger Band 進場不可替代回檔門檻** — BB(20,2) 對 USO 產生完全不同且遠更差的訊號集，Part B Sharpe -0.48（USO-015 Att2 驗證）。SIVR-013 再驗證：BB(20,2) 下軌入場 Part A Sharpe 0.01（熊市 9 連停損）/Part B 0.55（僅 4 訊號），BB(20,2.5) Part B 僅 1 訊號，+ATR>1.05 Part A -0.19。BB 在持續下跌中反覆觸及產生假訊號，在低波動期幾乎不觸及導致訊號不足
...
100. **Keltner Channel 不優於 Bollinger Band 用於突破策略** — KC(EMA20,ATR10,mult 2.5) + 30th pct squeeze vs BB(20,2) + 25th pct squeeze（XLU 比較）：KC Part A Sharpe 0.27（+50% vs BB 0.18），但 Part B 0.06（-77% vs BB 0.26）。KC 使用 ATR（含缺口/日內波動）而非 σ（收盤對收盤），理論上更全面，但**ATR-based 波動度在 OOS 期間比 σ-based 更不穩定**——ATR 對個別異常交易日（大缺口、寬幅震盪）更敏感，導致 KC 帶寬和突破門檻在不同市場環境中波動更大。KC 的 Part A 優勢來自 2019-2023 期間 ATR 恰好更有效率的過濾，但這種優勢不能推廣到 OOS。**結論：BB 的 σ-based 帶寬在低波動 ETF 上比 ATR-based 更穩定和可預測，不建議在其他低波動資產上用 KC 替代 BB**。ClosePos 對 KC 突破無效（突破日天然高 ClosePos）（XLU-009 驗證）

101. **動量回復/回檔後突破對高波動個股（日波動 >3%）無效** — TSLA（日波動 3.72%）三次嘗試均失敗：(1) 回檔→回復+SMA(5)（SL-8%）WR 37.5%/42.9%，Sharpe -0.26/-0.22；(2) 加深回檔-20%+SL-10% 更差（-0.45/-0.79）；(3) 20日高點突破 Part B 0.16 但 Part A -0.12，A/B 17:3 嚴重失衡。**核心問題：非超賣/非擠壓進場點的 SL 距離不足——均值回歸在極端超賣進場（WR 73%），容許寬 SL（-13%）；BB Squeeze 在波動收縮後進場（擴張方向明確），SL -7% 即足夠；動量回復在回檔回復後的「中性位置」進場，-8%～-10% SL 僅 2-3 天呼吸空間，正常波動即觸發停損**。TSLA 的有效策略需在特殊結構性位置（極端超賣或波動收縮）進場，而非回復後的中性位置（TSLA-011 Att1-3 驗證）
102. **RSI(5)+2日急跌不優於 WR(10) 作為 SIVR 均值回歸進場** — 三次嘗試：SL-4.5% Part A 0.17/Part B 0.21（min 0.17）、RSI<25+SL-3.5% Part A 0.26/Part B -0.02、SL-4.0% Part A 0.23/Part B 0.03。vs SIVR-005 WR(10) 0.22/0.26（min 0.22）。**核心發現：(a) WR(10) 的 10 日 High-Low 相對位置天然包含回檔深度資訊，與 pullback 條件互補；RSI(5) 的漲跌比例與 pullback 條件部分重疊，2 日急跌門檻未帶來額外區分力；(b) SL 存在結構性 A/B 張力——熊市需緊 SL 快止損、牛市需寬 SL 容忍暫時回撤，對稱 ±3.5% 是市場環境中立的全域折衷**（SIVR-011 驗證）
103. **ATR 波動率自適應過濾在日波動 >1.5% 的資產上跨期不穩定** — XLU-011（日波動 ~1.0-1.5%）ATR(5)/ATR(20)>1.15 極為成功（min Sharpe 0.18→0.67，+272%），但移植到 SIVR（日波動 2-3%）後 Part A Sharpe 0.22→0.41（+86%）而 Part B 0.26→0.12（-54%），min(A,B) 從 0.22 降至 0.12。ATR>1.10 引入壞訊號（Part A WR 70%→56.5%），SL -4.0% 未挽救 Part B 停損。**原因：高波動資產的 ATR 比率在正常交易中波動更大，1.15 門檻的區分力不如在低波動資產上穩定。過濾器在 Part A（含 COVID、2022 熊市等極端事件）有效移除慢速回檔假訊號，但在 Part B（2024-2025 不同市場環境）同時移除好訊號。ATR 過濾器有效邊界約為日波動 ≤ 1.5%，與 ClosePos 有效邊界（≤ 2.0%）類似**（SIVR-012 驗證）。**DIA-011 進一步驗證下界**：DIA 日波動 ~1.0%，ATR>1.1 移除 5 贏 1 輸（3 次嘗試 min 0.32~0.45 均 < DIA-005 的 0.47），DIA 訊號跨波動率制域均有效，ATR 無法區分好壞
104. **ATR 過濾應用於槓桿 ETF 底層指數仍然無效** — SOXL-011 Att1/Att2 嘗試將 ATR(5)/ATR(20) 應用於 SOXX（日波動 ~2-2.5%）而非 SOXL 本身（日波動 ~6.6%），假設降低波動度能讓 ATR 在有效邊界內運作。結果：ATR>1.05 和 ATR>1.1 產生完全相同的訊號集（Part A 7/10 訊號通過，Part B 5/5 全通過），min(A,B) 0.34（vs 基線 SOXL-006 的 0.47，-28%）。**原因：SOXL 均值回歸訊號觸發時 SOXX ATR ratio 呈二元分布——所有訊號 ATR ratio 要麼 >1.1（急跌恐慌）要麼 <1.05（非信號期），在 1.05-1.1 之間無有效梯度。ATR 移除的 3 個 Part A 訊號中 2 個為達標交易、1 個為停損（淨損失）。ATR 有效邊界確認為日波動 ≤2.0%，與底層指數還是直接交易標的無關**（SOXL-011 Att1/Att2 驗證）
105. **SOXX SMA 黃金交叉趨勢跟蹤在半導體板塊有嚴重 A/B 失衡** — SOXL-011 Att3：SOXX SMA(20)>SMA(50) + SOXL 5日回檔 10-20% + SOXX RSI(14)<45，TP+15%/SL-12%/20天。Part A Sharpe 0.42（17 訊號，64.7% WR，+114.74%），Part B Sharpe 0.11（6 訊號，50% WR，+3.33%），min(A,B) 0.11。**A/B 訊號比 2.83:1，原因：2019-2021 半導體 AI 牛市產生大量有效趨勢回檔訊號，2024-2025 盤整市場 WR 驟降至 50%。與 SPY-007/DIA-007 趨勢跟蹤失敗一致——SMA 交叉策略在不同市場制域有結構性弱點。半導體板塊的週期性使趨勢跟蹤比指數更不穩定**（SOXL-011 Att3 驗證）

106. **RS 動量在商品 ETF 上完全無效** — COPX-008 Att1/2：COPX-SPY 相對強度（RS(20d)≥5% 和 RS(10d)≥4%）+ 5日回調 3-8% + SMA(50)，Part A/B 均負 Sharpe（-0.07/-0.05 和 -0.09/-0.19）。銅礦 ETF 相對大盤超額表現不具動量延續性，與 FCX-006（商品生產者缺乏持續性超額表現驅動力）、SIVR-010（SIVR vs GLD RS 失敗）、URA-006（URA vs XLE RS 失敗）一致。RS 動量僅在半導體板塊個股/槓桿 ETF 有效（SOXL-010、TSM-008、NVDA-004），可能因為 AI/半導體週期有持續性板塊 alpha（COPX-008 Att1/2 驗證）
107. **Donchian 突破在銅礦 ETF 上可行但劣於均值回歸** — COPX-008 Att3：20日新高突破 + SMA(50)，TP+3.5%/SL-4.5%/20d。Part A Sharpe 0.17/Part B 0.16，A/B gap 0.01（極佳平衡），WR 64%/65%。但 min(A,B) 0.16 遠低於 COPX-007 均值回歸的 0.45（-64%）。原因：WR 64% 搭配不對稱 TP/SL（+3.5% vs -4.64%）= 低盈虧比（1.41）。Donchian 優於 BB Squeeze Breakout（COPX-005 Part B -0.17/0.01），但仍確認銅礦 ETF 的最佳策略是波動率自適應均值回歸（COPX-008 Att3 驗證）
...
## 56. ATR 波動率過濾有效邊界確認：日波動 ≤ 1.5-2.0%

<!-- freshness:
  derived_from: [IWM-011, XLU-011, SIVR-012, XBI-009]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: high
-->

ATR(5)/ATR(20) 波動率過濾在低波動資產上是突破性改進，但在 2.0% 日波動邊界上失效。

| 日波動 | 資產 | ATR 門檻 | 結果 |
|--------|------|---------|------|
| ~1.0% | XLU | > 1.15 | min(A,B) 0.18→0.67（+272%）★ |
| 1.5-2.0% | IWM | > 1.1 | min(A,B) 0.31→0.52（+67.7%）★ |
| ~2.0% | XBI | > 1.1 | min(A,B) 0.36→0.16（-55%）✗ |
| ~2.0% | XBI | > 1.05 | min(A,B) 0.36→-0.08 ✗ |
| 2-3% | SIVR | > 1.1+ | Part A 0.41 但 Part B 0.12，跨期不穩定 ✗ |

**原因**：低波動資產（≤ 1.5%）的慢速下磨和急跌恐慌的 ATR 比率差異顯著，過濾器可精準區分。在 2.0% 日波動邊界上，好壞訊號的 ATR 比率分布重疊，過濾器隨機移除好壞訊號。

**規則**：ATR 波動率過濾僅在日波動 ≤ 1.5% 的資產上可靠。1.5-2.0% 需極謹慎測試（IWM 成功但 XBI 失敗），> 2.0% 禁用。

---

## 57. RSI(2) 框架不適合事件驅動的板塊 ETF

<!-- freshness:
  derived_from: [XBI-009, XBI-002, COPX-006]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: high
-->

RSI(2) 在指數 ETF（SPY/DIA/IWM/VOO）上表現優異，但對事件驅動的板塊 ETF（XBI、COPX）無效。

| 資產 | 日波動 | RSI(2) 結果 | pullback+WR 結果 |
|------|--------|-----------|-----------------|
| SPY | 1.0-1.2% | min 0.53 ★ | — |
| DIA | ~1.1% | min 0.47 ★ | — |
| IWM | 1.5-2.0% | min 0.52（+ATR）★ | — |
| XBI | ~2.0% | min -0.04 ✗（WR 62.5%/57.1%） | min 0.36（WR 76.2%/83.3%）★ |
| COPX | 2-3% | Part A 0.01/Part B 0.21 ✗ | min 0.35 ★ |
...
<!-- freshness:
  derived_from: [SIVR-005, TSLA-012]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: high
-->

Cross-asset lesson #40（SIVR 均值回歸 + 成交量過濾）的發現延伸至突破策略。

| 資產 | 策略類型 | 成交量條件 | 結果 |
|------|----------|-----------|------|
| SIVR | 均值回歸 | Volume ≥ 1.2x 20日均量 | Part B Sharpe 0.26→0.12（移除 4 筆好訊號）|
| TSLA | BB 擠壓突破 | Volume ≥ 1.3x 20日均量 | Part A Sharpe 0.40→0.22（WR 58.8%→50.0%），Part B 訊號 6→3 |

**原因**：TSLA 突破訊號的好壞與成交量無系統性關聯。好的突破不一定發生在高量日（可能是逐步累積後的平穩突破），壞的突破也可能有高量（投機性追漲後快速反轉）。

**規則**：不要在任何策略類型上使用成交量過濾器。

---

## 14. SMA 趨勢週期變更改變過濾方向而非改善品質

<!-- freshness:
  derived_from: [TSLA-012]
  validated: 2026-04-09
  data_through: 2025-12-31
  confidence: medium
-->

將 BB Squeeze Breakout 的趨勢過濾從 SMA(50) 改為 SMA(100)，效果是改變過濾方向而非統一改善。

- SMA(100) 在上升趨勢中比 SMA(50) 更低 → 更寬鬆，讓通早期假訊號
- SMA(100) 在下降趨勢中比 SMA(50) 更高 → 更嚴格，但過濾的未必是壞訊號
- TSLA Part B MDD 從 -11.37% 惡化至 -20.35%，Sharpe 0.53→0.17

**規則**：SMA(50) 是 BB Squeeze Breakout 趨勢過濾的甜蜜點（NVDA-004 Att3 亦驗證 SMA(20) 太短）。不要將 SMA 週期作為調優手段。

---

## 15. 2日急跌過濾改善 OOS 但犧牲 IS 訊號密度
...
2日急跌過濾（pct_change(2) ≤ threshold）在 USO-013 極為成功（Sharpe 0.26/0.82），但移植到 FCX-008（三重超賣 + 2日跌幅 ≤ -5%）時效果不一致：Part B 大幅改善（0.74→1.26），Part A 退化（0.43→0.31）。

原因：FCX 極端超賣條件（DD -18% + RSI<28 + SMA 乖離 -8%）本身已高度選擇性（3.6 訊號/年），再加急跌過濾移除 5 筆 Part A 訊號中 3 筆為贏利交易。USO 基礎訊號較密（7.0/年），過濾後仍保留足夠好訊號。

**規則**：2日急跌過濾在基礎訊號頻率 ≥ 5/年的資產上有效（USO、COPX），但在訊號已稀少的資產上（FCX ~3.6/年）會過度移除好訊號。

---

## 16. ATR 波動率過濾對極端超賣進場條件無額外區分力

<!-- freshness:
  derived_from: [FCX-008, COPX-007, IWM-011]
  validated: 2026-04-10
  data_through: 2025-12-31
  confidence: medium
-->

ATR(5)/ATR(20) > 1.05 波動率過濾在 COPX-007（min +28.6%）和 IWM-011（min +67.7%）上有效，但在 FCX-008 Att2 上失敗（Part A 0.43→0.25）。

關鍵差異：COPX/IWM 的基礎進場條件（回檔+WR）不包含波動率維度，ATR 提供正交的新資訊。但 FCX-001 的三重條件（DD -18% + RSI<28 + SMA 乖離 -8%）本身就要求價格劇烈下跌才能同時觸發，隱含了高 ATR 前提。ATR 過濾器對這些訊號只是重複已知資訊，移除的邊際訊號中好壞不可區分。

**規則**：ATR 波動率過濾僅在基礎進場條件不含波動率維度時有效。若進場條件已隱含高波動（深回撤 + 低 RSI + 大乖離），ATR 無額外區分力。
