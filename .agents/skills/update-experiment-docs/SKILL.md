...
- [Read results and identify the asset document](#step-1-read-results)
- [Update result tables and rolling analysis](#step-3-update-results-tables)
- [Update AI context and cross-asset lessons](#step-4-update-ai_context-block)
- [Refresh dates and verify](#step-6-update-freshness-dates)
- [Rules](#rules)
...
If `trading analyze` was already run in the same session through `$run-experiment`, use those results. Otherwise, run:
