"""
SOXL 深度超賣 + 成交模型策略 (SOXL Deep Oversold + Execution Model Strategy)
基於 SOXL-001，加深進場門檻並改善盈虧比。
"""
...
from trading.experiments.soxl_002_deep_oversold.config import (
    SOXLDeepOversoldConfig,
    create_default_config,
)
from trading.experiments.soxl_002_deep_oversold.signal_detector import (
    SOXLDeepOversoldSignalDetector,
)
