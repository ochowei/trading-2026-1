...
from trading.experiments.uso_009_momentum_pullback.signal_detector import (
    USOMomentumPullbackSignalDetector,
)
...
class USOMomentumPullbackStrategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return USOMomentumPullbackSignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, USOMomentumPullbackConfig):
            print(
