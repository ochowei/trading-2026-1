"""EWT–EEM Cross-Asset Divergence Regime-Gated MR 策略 (EWT-010)"""

from trading.core.base_config import ExperimentConfig
from trading.core.base_signal_detector import BaseSignalDetector
from trading.core.execution_strategy import ExecutionModelStrategy
from trading.experiments.ewt_010_eem_divergence_regime_mr.config import (
    EWT010Config,
    create_default_config,
)
from trading.experiments.ewt_010_eem_divergence_regime_mr.signal_detector import (
    EWT010SignalDetector,
)


class EWT010EemDivergenceRegimeMRStrategy(ExecutionModelStrategy):
    """EWT-010：EWT-009 Att3 + EWT–EEM 跨資產 divergence regime gate"""
