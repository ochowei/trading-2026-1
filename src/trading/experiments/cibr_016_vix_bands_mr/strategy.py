"""CIBR-016: ^VIX Implied-Vol Regime BANDS Filter MR 策略
...
from trading.experiments.cibr_016_vix_bands_mr.config import (
    CIBR016Config,
    create_default_config,
)
from trading.experiments.cibr_016_vix_bands_mr.signal_detector import (
    CIBR016VixBandsMRDetector,
)


class CIBR016VixBandsMRStrategy(ExecutionModelStrategy):
    """CIBR-016：^VIX BANDS Filter MR 策略（含成交模型）"""
    ...
    def create_detector(self) -> BaseSignalDetector:
        return CIBR016VixBandsMRDetector(create_default_config())
