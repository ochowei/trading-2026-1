...
EEM-001 RSI(2) framework + ATR(5)/ATR(20) ratio filter to distinguish
...
from trading.experiments.eem_002_vol_adaptive_rsi2.signal_detector import (
    EEM002SignalDetector,
)
...
class EEM002Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return EEM002SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, EEM002Config):
