"""
TSM-022: ^VXN Forward-Looking Implied-Vol DIRECTION Regime-Gated RS Momentum Pullback 策略
...
from trading.experiments.tsm_022_vxn_implied_vol_rs.signal_detector import (
