...
from trading.experiments.ewt_002_vol_adaptive_pullback.config import EWT002Config

logger = logging.getLogger(__name__)


class EWT002SignalDetector(BaseSignalDetector):
    def __init__(self, config: EWT002Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("EWT-002: Detected %d vol-adaptive pullback signals", signal_count)
        return df
