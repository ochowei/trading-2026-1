"""
COPX-007: 波動率自適應均值回歸策略
(COPX Volatility-Adaptive Mean Reversion Strategy)

基於 COPX-003 + ATR(5)/ATR(20) 波動率飆升過濾。
"""
...
from trading.experiments.copx_007_vol_adaptive.signal_detector import (
    COPX007SignalDetector,
)
...
class COPX007Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return COPX007SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, COPX007Config):
            print(
