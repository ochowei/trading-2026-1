"""EWJ ^VIX Forward-Looking Implied-Vol Regime-Gated MR 策略 (EWJ-007)"""
...
from trading.experiments.ewj_007_vix_implied_vol_mr.signal_detector import (
    EWJ007SignalDetector,
)
...
class EWJ007Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return EWJ007SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, EWJ007Config):
