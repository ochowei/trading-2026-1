"""XBI-018: ^VIX Implied-Vol DIRECTION Regime Gate Pullback MR 策略
...
from trading.experiments.xbi_018_vix_direction_mr.config import (
    XBI018Config,
    create_default_config,
)
from trading.experiments.xbi_018_vix_direction_mr.signal_detector import (
    XBI018VixDirectionMRDetector,
)


class XBI018VixDirectionMRStrategy(ExecutionModelStrategy):
    """XBI-018：^VIX DIRECTION CEILING Filter MR 策略（含成交模型）"""
    ...
    def create_detector(self) -> BaseSignalDetector:
        return XBI018VixDirectionMRDetector(create_default_config())
