...
| FCX-015 | `fcx_015_vix_bands_breakout`  | VIX BANDS Filter on BB Squeeze Breakout（FCX-014 Att1 + **^VIX > 14.0 FLOOR**，**Att2 SUCCESS min(A,B)† 1.43 +123%**，repo 第 2 次 lesson #24 BANDS 變體 + 首次 BANDS 變體於 BB Squeeze Breakout + 首次 ^VIX FLOOR 變體於任何資產，A/B cum gap 52.5%→7.1% 突破 FCX 商品超級週期結構性邊界） | ★ 突破策略當前最佳 |
| FCX-016 | `fcx_016_postparabola_regime_breakout` | Post-Parabolic 長窗 prior-Nd-return CEILING（FCX-015 Att2 + 跨資產移植 URA-014 lesson #19 family v3，3 次迭代全部 FAIL/REJECT，**predict→confirm documented-failure 正確預測**：FCX SL 2021-11-11 Ret60 與 winners 完全 interleaved 且方向 INVERTED vs URA-014） | 已完成（documented-failure） |
