...
class TLTPullbackWRReversalStrategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """TLT 回檔範圍 + Williams %R + 反轉K線均值回歸策略 (TLT-001)"""

    bundle_trial_family = "TLT:pullback-wr-reversal"
    bundle_trial_hypothesis = (
        "TLT pullback and Williams %R reversal can be reproduced from a verified primary bundle."
    )
