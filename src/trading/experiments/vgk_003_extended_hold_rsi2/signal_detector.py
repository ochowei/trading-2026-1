...
from trading.experiments.vgk_003_extended_hold_rsi2.config import VGK003Config
...
class VGK003SignalDetector(BaseSignalDetector):
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("VGK-003: Detected %d RSI(2) extended-hold signals", signal_count)
        return df
