"""GLD–USD Cross-Asset Divergence Regime-Gated MR 策略 (GLD-016)"""

from trading.core.base_config import ExperimentConfig
from trading.core.base_signal_detector import BaseSignalDetector
from trading.core.execution_strategy import ExecutionModelStrategy
from trading.experiments.gld_016_usd_regime_mr.config import (
    GLD016Config,
    create_default_config,
)
from trading.experiments.gld_016_usd_regime_mr.signal_detector import (
    GLD016SignalDetector,
)


class GLD016UsdRegimeMRStrategy(ExecutionModelStrategy):
    """GLD-016：GLD-015 Att2 + GLD–USD 跨資產 divergence regime gate"""
