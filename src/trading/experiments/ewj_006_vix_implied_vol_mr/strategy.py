"""EWJ ^VIX Forward-Looking Implied-Vol Regime-Gated MR 策略 (EWJ-006)"""

from trading.core.base_config import ExperimentConfig
from trading.core.base_signal_detector import BaseSignalDetector
from trading.core.execution_strategy import ExecutionModelStrategy
from trading.experiments.ewj_006_vix_implied_vol_mr.config import (
    EWJ006Config,
    create_default_config,
)
from trading.experiments.ewj_006_vix_implied_vol_mr.signal_detector import (
    EWJ006SignalDetector,
)


class EWJ006Strategy(ExecutionModelStrategy):
    """EWJ-006：EWJ-005 Att2 框架 + ^VIX forward-looking implied vol regime gate"""
    ...
    def create_detector(self) -> BaseSignalDetector:
        return EWJ006SignalDetector(create_default_config())
