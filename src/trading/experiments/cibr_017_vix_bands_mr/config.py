"""
CIBR-017: ^VIX Implied-Vol Regime BANDS Filter Mean Reversion 配置
...
================================================================================
CIBR-017 新增（^VIX BANDS gate；XBI-017 跨資產移植）
================================================================================
...
@dataclass
class CIBR017Config(ExperimentConfig):
    """CIBR-017 ^VIX Implied-Vol Regime BANDS Filter MR 參數"""
    ...
    # === ^VIX BANDS regime gate（CIBR-017 核心新增，XBI-017 跨資產移植）===
    # 訊號通過條件：VIX <= vix_low_threshold OR VIX > vix_high_threshold
...
def create_default_config() -> CIBR017Config:
    """建立預設配置（Att1：XBI-017 Att1 直接移植 vix_bands (17, 22)）"""
    return CIBR017Config(
        name="cibr_017_vix_bands_mr",
        experiment_id="CIBR-017",
