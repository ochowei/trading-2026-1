"""
XBI-007 訊號偵測器：Momentum Pullback
XBI-007 Signal Detector: Momentum Pullback
...
class XBIMomentumPullbackDetector(BaseSignalDetector):
    """XBI Momentum Pullback 訊號偵測器"""

    def __init__(self, config: XBIMomentumPullbackConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("XBI: Detected %d momentum pullback signals", signal_count)
        return df
