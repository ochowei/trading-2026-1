"""
DIA-011 訊號偵測器：波動率自適應 RSI(2) 均值回歸
...
from trading.experiments.dia_011_vol_adaptive_rsi2.config import DIA011Config

logger = logging.getLogger(__name__)


class DIA011SignalDetector(BaseSignalDetector):
    def __init__(self, config: DIA011Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("DIA-011: Detected %d vol-adaptive RSI(2) signals", signal_count)
        return df
