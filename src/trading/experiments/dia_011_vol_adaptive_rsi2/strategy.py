...
class DIA011Strategy(PrimaryBundleStrategyMixin, ExecutionModelStrategy):
    """DIA 波動率自適應 RSI(2) 均值回歸 (DIA-011)"""

    bundle_trial_family = "DIA:vol-adaptive-rsi2"
    bundle_trial_hypothesis = (
        "DIA volatility-adaptive RSI(2) can be reproduced from a verified primary bundle."
    )
