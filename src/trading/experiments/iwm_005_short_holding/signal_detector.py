"""
IWM-005 訊號偵測器：RSI(2) 極端超賣均值回歸
(IWM-005 Signal Detector: RSI(2) Extreme Oversold Mean Reversion)
...
class IWM005SignalDetector(BaseSignalDetector):
    def __init__(self, config: IWM005Config):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("IWM-005: Detected %d RSI(2) extreme oversold signals", signal_count)
        return df
