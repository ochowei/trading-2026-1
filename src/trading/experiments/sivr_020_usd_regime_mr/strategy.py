"""
SIVR-020: SIVR–USD Cross-Asset Divergence Regime-Gated MR
...
from trading.experiments.sivr_020_usd_regime_mr.signal_detector import (
    SIVR020SignalDetector,
)
...
class SIVR020Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return SIVR020SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, SIVR020Config):
            print(
