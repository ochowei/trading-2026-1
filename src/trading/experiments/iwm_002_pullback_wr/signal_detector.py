"""
IWM-002 訊號偵測器：回檔 + Williams %R 均值回歸
...
from trading.experiments.iwm_002_pullback_wr.config import IWMPullbackWRConfig

logger = logging.getLogger(__name__)


class IWMPullbackWRSignalDetector(BaseSignalDetector):
    """
