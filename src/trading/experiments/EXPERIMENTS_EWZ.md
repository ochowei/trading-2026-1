...
| EWZ-010 | `ewz_010_brl_regime_mr`          | EWZ–BRL Currency-Regime-Gated Vol-Transition MR（cross-asset divergence/currency regime gate family v4 driver-purity 第 5 個 driver-impure subclass：commodity-driven single-country EM equity vs own currency BRL，FXI-015 精確 isomorph，禁忌 #36e）| ❌ 三次迭代全 documented-failure（predict→confirm 命中） |
