...
- pullback+WR(10)+ATR+ClosePos 框架在 EWZ 上無可替代（4 次實驗、9 次迭代確認）
...
| 參數 | EWZ-001 | EWZ-002 Att3★ | EWZ-003 Att3 | EWZ-004 Att3 |
|------|---------|---------------|--------------|--------------|
| 進場框架 | 10日回檔≥7% + WR(10)≤-80 | 10日回檔 7-10% + WR(10)≤-80 | 2日急跌≤-3.5% + WR(10)≤-70 | 10日回檔 7-10% + WR(5)≤-80 |
| ClosePos | 無 | ≥40% | ≥35% | ≥40% |
| ATR 過濾 | 無 | ATR(5)/ATR(20)>1.1 | ATR(5)/ATR(20)>1.1 | 無 |
| TP | +4.0% | +5.0% | +5.0% | +5.0% |
| SL | -4.0% | -4.0% | -4.0% | -4.0% |
| 持倉 | 15天 | 18天 | 15天 | 18天 |
| 冷卻期 | 10天 | 10天 | 10天 | 10天 |
| **Part A Sharpe** | **0.10** | **0.34** | **0.02** | **-0.03** |
| **Part B Sharpe** | **0.60** | **12.85** | **2.35** | **0.56** |
| **min(A,B) Sharpe** | **0.10** | **0.34** | **0.02** | **-0.03** |
