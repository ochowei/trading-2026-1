...
- 出場（均值回歸）：**TP+5.5%/SL-5.0%/20d（★新最佳）**、TP+5%/SL-4.5%/18d、TP+5.5%/SL-5.5%/22d、TP+3.5%/SL-3.5%/15d
- 冷卻期：10d（★）、15d（移除好訊號）
...
| 參數 | FXI-001 | FXI-002 Att3 | FXI-003 Att2 | FXI-004 Att3 | FXI-005 Att3★ |
|------|---------|--------------|-------------|-------------|---------------|
| 策略類型 | 均值回歸 | 均值回歸 | BB 擠壓突破 | 均值回歸（2d decline） | 出場優化均值回歸 |
| 回檔門檻 | ≥7% | ≥5% | — | ≥5% | ≥5% |
| 回檔上限 | 無 | ≤12% | — | ≤12% | ≤12% |
| 超賣指標 | WR(10)≤-80 | WR(10)≤-80 | — | WR(10)≤-80 | WR(10)≤-80 |
| ClosePos | 無 | ≥40% | — | 無 | ≥40% |
| ATR 過濾 | 無 | >1.05 | — | 無 | >1.05 |
| 2日急跌 | 無 | 無 | — | ≤-2.0% | 無 |
| BB Squeeze | — | — | 30th pct/60日 | — | — |
| SMA 趨勢 | — | — | SMA(50) | — | — |
| TP | +3.5% | +5.0% | +3.5% | +5.0% | **+5.5%** |
| SL | -3.5% | -4.5% | -5.0% | -4.5% | **-5.0%** |
| 持倉 | 15天 | 18天 | 20天 | 18天 | **20天** |
| 冷卻 | 10天 | 10天 | 10天 | 10天 | 10天 |
| Part A Sharpe | -0.17 | 0.33 | -0.12 | 0.01 | **0.38** |
| Part B Sharpe | -0.11 | 0.50 | 0.14 | 0.05 | **1.61** |
| min(A,B) | -0.17 | 0.33 | -0.12 | 0.01 | **0.38** |
