<!-- AI_CONTEXT_START - 此區塊供 AI Agent 快速讀取，人工更新
  ...
  phase9_note_2026_08_06: EWT-007, EWT-010, EWT-011, and EWT-012 now consume declared EEM historical auxiliary bundles through the provider-free execution boundary; migration runs remain migration-pending and do not advance latest or followup qualification.
  phase9_note_2026_08_06_primary_wave: EWT-002, EWT-003, EWT-004, EWT-005, EWT-006, EWT-008, and EWT-009 now use the shared primary-only verified bundle boundary; migration runs remain pending and do not advance latest or followup qualification.
...
| EWT-007 | `ewt_007_rs_momentum`          | RS 動量回調（EWT vs EEM 相對強度；Phase 9 auxiliary bundle，migration-pending） | 已完成 |
...
| EWT-010 | `ewt_010_ewt_eem_2d_divergence_mr` | EWT-EEM 2D Cross-Asset Divergence Filter on Vol-Transition MR（雙時框 20d AND 60d AND 條件）— 文件最優但雙 Part std=0 退化；Phase 9 auxiliary bundle，migration-pending | 已完成 |
| EWT-011 | `ewt_011_vol_gated_rs_momentum` | RS-Freshness Dual-Window Filter on RS Momentum Pullback（EWT-007 base + EWT−EEM 10d RS > -1%；Att1 vol gate 失敗）★ **真實穩健最優 min(A,B) 0.56 (+33% vs EWT-007 0.42)，雙 Part 真實變異**；Phase 9 auxiliary bundle，migration-pending | 已完成 |
| EWT-012 | `ewt_012_eem_divergence_regime_mr` | EWT–EEM 跨資產 divergence regime gate（family v4 第 2 次失敗；Phase 9 auxiliary bundle，migration-pending）| 已完成（無效）|
