...
**當前最佳：** EWT-004 Att1（2日急跌過濾+非對稱出場：10日回檔4-10% + WR(10)≤-80 + ClosePos≥40% + ATR(5)/ATR(20)>1.15 + 2日報酬≤-1.5%，TP+5.0%/SL-4.5%/20d，無追蹤停損）
...
**已掃描的參數空間：**
- 進場：10日回檔 4-10% + WR(10) ≤-80 + ClosePos ≥40% + ATR > 1.15/1.1 + 2日跌幅 ≤-1.5%
- 出場：TP +4.5~5.0% / SL -4.5~5.5% / 持倉 18~20天 / 無追蹤停損
...
- SL -4.5% 是甜蜜點（-5.0/-5.5% 均退化，2022 熊市 SL 交易穿越力度大）
<!-- AI_CONTEXT_END -->
...
| 參數 | EWT-001 | EWT-002 Att1 | EWT-003 | EWT-004 Att1 ★ |
|------|---------|-------------|---------|----------------|
| 策略類型 | 均值回歸（追蹤停損）| 均值回歸（ATR 自適應）| BB Squeeze 突破 | 均值回歸（2日急跌+非對稱）|
...
| 冷卻期 | 8 | 8 | 10 | 8 |
| Part A Sharpe | 0.10 | 0.13 | 0.35 | **0.15** |
| Part B Sharpe | 0.57 | 0.64 | -0.37 | **0.48** |
| min(A,B) | 0.10 | 0.13 | -0.37 | **0.15** |
