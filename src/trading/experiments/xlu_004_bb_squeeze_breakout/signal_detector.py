"""
XLU-004 訊號偵測器：Bollinger Band Squeeze Breakout
XLU-004 Signal Detector: BB Squeeze Breakout
...
from trading.experiments.xlu_004_bb_squeeze_breakout.config import XLU004BBSqueezeConfig

logger = logging.getLogger(__name__)


class XLU004BBSqueezeDetector(BaseSignalDetector):
    """XLU BB Squeeze Breakout 訊號偵測器"""

    def __init__(self, config: XLU004BBSqueezeConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("XLU-004: Detected %d BB squeeze breakout signals", signal_count)
        return df
