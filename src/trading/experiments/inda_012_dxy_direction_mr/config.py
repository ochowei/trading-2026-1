"""
INDA DXY Direction Filter MR 配置 (INDA-012)
...
- INDA-012 為該假設於「單一國家 EM 股票 ETF」之首次驗證
...
========================================================================
結論：INDA-012 三次迭代全部 FAIL，INDA-011 Att3（min 0.55）維持全域最優
========================================================================
...
class INDA012Config(ExperimentConfig):
    """INDA-012 DXY Direction Filter MR 參數"""
...
def create_default_config() -> INDA012Config:
    ...
    return INDA012Config(
        name="inda_012_dxy_direction_mr",
