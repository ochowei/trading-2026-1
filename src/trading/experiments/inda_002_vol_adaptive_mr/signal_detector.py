...
class INDAVolAdaptiveMRDetector(BaseSignalDetector):
    def __init__(self, config: INDAVolAdaptiveMRConfig):
        self.config = config
    ...
    def detect_signals(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        logger.info("INDA-002: Detected %d vol-adaptive MR signals", signal_count)
        return df
