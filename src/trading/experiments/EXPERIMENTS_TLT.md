...
**已掃描的參數空間：**
- 進場條件：回檔 3-7% / 5-10% + WR(10) ≤ -80 + ClosePos ≥ 40%（有/無 60日跌幅過濾）
- RSI(2) < 10 + 2日跌幅 ≥ 1.5% + ClosePos ≥ 40%
- 出場參數：TP +2.0~3.0% / SL -3.5~-5.0% / 持倉 20 天
- 冷卻期：7 / 10 / 15 天
...
- **TLT 的核心限制**：2022 升息產生大量無法被技術面過濾器區分的假訊號。出場參數（SL -3.5%~-5.0%、TP +2.5%~+3.0%）、冷卻期（7~15天）、中期跌幅過濾均無法有效改善 Part A
- **SL -4.0% 為 Part B 最佳**：TLT-003 Att3 驗證 SL -4.0%/cd10 使 Part B Sharpe 從 0.24 升至 0.46，但 Part A 維持 -0.20，A/B 失衡加劇
<!-- AI_CONTEXT_END -->
