...
| TLT-013 | `tlt_013_move_implied_vol_mr`    | ^MOVE forward-looking implied vol regime 閘門 MR（**repo 首次 ^MOVE 過濾於任何資產**，Att1 SUCCESS）| ✅ **當前最佳**（首次突破 TLT 0.12 ceiling，+17%）|
