"""FXI–CNY Currency-Regime-Gated MR 策略 (FXI-017)
...
from trading.experiments.fxi_017_cny_regime_mr.signal_detector import (
    FXI017SignalDetector,
)
...
class FXI017CnyRegimeMRStrategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return FXI017SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, FXI017Config):
            print(
