...
**最新實驗：** TQQQ-029（TQQQ Donchian Channel Trend-Following — **策略方向：趨勢跟蹤 (Trend Following)，repo 首次 Turtle 式 Donchian 趨勢跟蹤於 TQQQ，3 次漸進改善但全部 REJECT**）—— 詳見 AI_CONTEXT note_2026_05_16_tqqq029
...
> **最新實驗 (Latest):** TQQQ-029 `tqqq_029_donchian_trend`（趨勢跟蹤 Trend Following — TQQQ Donchian N 日高點 + 趨勢確認，repo 首次 Turtle 式 Donchian 趨勢跟蹤於 TQQQ，3 次漸進改善 min -0.01→0.01→0.16 但全部 REJECT — 3x leverage 與趨勢跟蹤根本張力；整合 TQQQ-006/015/027/028/029：leveraged tech ETF 僅逆勢深度 capitulation 維度可產生 alpha，順勢維度全失敗）
