...
**最新實驗：** TQQQ-027（QQQ Single-Day Momentum-Reversal MR → Trade TQQQ — **策略方向：均值回歸 / 單日動量反轉，repo 首次 QQQ 單日反轉維度，3 次全部 REJECT**）—— 詳見 AI_CONTEXT note_2026_05_16_tqqq027
...
> **最新實驗 (Latest):** TQQQ-027 `tqqq_027_qqq_single_day_reversal`（均值回歸 / 單日動量反轉 — QQQ ROC(1)+ClosePos → Trade TQQQ，repo 首次 QQQ 單日反轉維度，3 次全部 REJECT — 單日反轉過稀或過噪二擇一、缺乏深度 capitulation 脈絡約 50/50 reversion，推廣 TQQQ-016 結論至 QQQ underlying 維度）
