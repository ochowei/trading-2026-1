...
**當前最佳：** TQQQ-018 Att3（Volatility-Regime-Gated Capitulation Buy：TQQQ-010 三條件 + **BB(20,2) Width/Close < 0.48** regime gate + **Drawdown(T-5) <= -1%** first-day-of-decline filter，TP +7% / SL -8% / 10 天 / cd 3 / slippage 0.1%）★ **2026-04-28 新全域最優（24 次實驗，12 大策略類型）**

**最新實驗：** TQQQ-024（Post-Capitulation Vol-Transition MR — **repo 首次「完全替代 framework」於 TQQQ，3 次嘗試全部 REJECT vs TQQQ-018 baseline 0.80**，驗證 vol-transition MR framework 於 leveraged tech ETF 結構性失敗）—— 詳見 AI_CONTEXT note_2026_05_09_tqqq024
