...
**最新實驗：** TQQQ-026（TQQQ/SQQQ Inverse-Pair Capitulation Confirmation — **策略方向：配對交易 (Pair Trading)，repo 首次 inverse-pair confirmation gate，3 次 TIE/PARTIAL 全部未超越現任最佳**）—— 詳見 AI_CONTEXT note_2026_05_16_tqqq026
...
> **最新實驗 (Latest):** TQQQ-026 `tqqq_026_sqqq_pair_divergence`（配對交易 Pair Trading — TQQQ/SQQQ Inverse-Pair Capitulation Confirmation，repo 首次 leveraged inverse-pair confirmation gate，3 次 TIE/PARTIAL 未超越 — SQQQ inverse-pair RSI 與 capitulation 結構性共線、-3x↔+3x 機械鏡射無正交增量資訊）
