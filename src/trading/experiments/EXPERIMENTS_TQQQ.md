...
**最新實驗：** TQQQ-028（TQQQ BB Squeeze Breakout — **策略方向：突破 (Breakout)，repo 首次 TQQQ 自身 BB squeeze 突破，3 次全部 REJECT**）—— 詳見 AI_CONTEXT note_2026_05_16_tqqq028
...
> **最新實驗 (Latest):** TQQQ-028 `tqqq_028_bb_squeeze_breakout`（突破 Breakout — TQQQ 自身 BB squeeze + 上軌突破，repo 首次 TQQQ-native squeeze breakout，3 次全部 REJECT — 3x leverage 放大假突破 whipsaw、squeeze 閾值兩難、trend filter 對 Part B 非綁定，與 TQQQ-015 平行；leveraged tech ETF 僅 MR/capitulation 維度有效）
