...
from trading.experiments.inda_008_bb_lower_pullback_cap.signal_detector import (
    INDA008SignalDetector,
)
...
class INDA008Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return INDA008SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, INDA008Config):
