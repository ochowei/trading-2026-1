<!-- AI_CONTEXT_START - 此區塊供 AI Agent 快速讀取，人工更新
  ...
  phase9_note_2026_08_06: EWJ-004, EWJ-006, and EWJ-007 now consume declared SPY/JPY=X/^VIX historical auxiliary bundles through the provider-free execution boundary; migration runs remain migration-pending and do not advance latest or followup qualification.
  phase9_note_2026_08_06_primary_wave: EWJ-001, EWJ-003, and EWJ-005 now use the shared primary-only verified bundle boundary; migration runs remain pending and do not advance latest or followup qualification.
...
| EWJ-004 | `ewj_004_rs_momentum` | RS 動量回調（EWJ vs EFA/SPY，3 次嘗試均失敗；Phase 9 auxiliary bundle，migration-pending） | 已完成（失敗，確認 lesson #25 擴展至 DM） |
| EWJ-005 | `ewj_005_vol_transition_mr` | Post-Capitulation Vol-Transition MR（EWJ-003 + 1d floor）| 已完成（前最佳） |
| EWJ-006 | `ewj_006_usdjpy_direction_mr` | USDJPY Direction-Gated Vol-Transition MR（EWJ-005 + USDJPY 10d <= +1.0%；Phase 9 auxiliary bundle，migration-pending）★ | ✅ 當前最佳 |
| EWJ-007 | `ewj_007_vix_implied_vol_mr` | ^VIX Forward-Looking Implied-Vol Regime-Gated MR（EWJ-005 Att2 + ^VIX gate，3 次嘗試均失敗；Phase 9 auxiliary bundle，migration-pending） | 已完成（失敗，^VIX 對 EWJ 結構性無區分力） |
