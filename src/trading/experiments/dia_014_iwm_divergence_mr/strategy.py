"""
DIA-014: DIA-IWM Cross-Asset Divergence CEILING Regime-Gated MR Strategy
...
from trading.experiments.dia_014_iwm_divergence_mr.signal_detector import (
    DIA014SignalDetector,
)
...
class DIA014Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return DIA014SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, DIA014Config):
