...
- ~~動量回調（lesson #26 警告市場狀態依賴）~~ → EEM-006 已驗證 RS 動量在 EEM 上因宏觀事件驅動而失敗
...
| 參數 | EEM-001 | EEM-003 (Att2) | EEM-004 (Att1) | EEM-005 (Att2) ★ | EEM-006 (Att1) |
|------|---------|----------------|----------------|-------------------|----------------|
| 策略類型 | 均值回歸 | 均值回歸 | 均值回歸 | **突破** | **RS 動量** |
| RSI(2) | < 10 | < 10 | — | — | — |
| 2日跌幅 | ≥ 1.5% | ≥ 1.5% | — | — | — |
| ClosePos | ≥ 40% | ≥ 40% | ≥ 40% | — | — |
| ATR(5)/ATR(20) | — | > 1.15 | — | — | — |
...
| 冷卻期 | 5 天 | 10 天 | 10 天 | 10 天 | 10 天 |
| TP / SL | +3.0% / -3.0% | +3.0% / -3.0% | +3.0% / -3.0% | +3.0% / -3.0% | +3.0% / -3.0% |
| 持倉 | 20 天 | 20 天 | 20 天 | 20 天 | 20 天 |
| Part A Sharpe | -0.13 | +0.06 | 0.01 | **+0.20** | 0.34 |
| Part B Sharpe | 0.35 | 0.00 (100%WR) | 0.27 | **+0.18** | -0.23 |
| Part A 訊號 | 28 (5.6/yr) | 13 (2.6/yr) | 45 (9.0/yr) | 18 (3.6/yr) | 9 (1.8/yr) |
| Part B 訊號 | 7 (3.5/yr) | 5 (2.5/yr) | 12 (6.0/yr) | 10 (5.0/yr) | 5 (2.5/yr) |
