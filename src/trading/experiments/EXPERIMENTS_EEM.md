...
**當前最佳：** EEM-005 Att2（BB Squeeze 30th 百分位 + SMA(50) + TP3.0%/SL3.0%/20天 + 冷卻10天，Part A Sharpe 0.20，Part B Sharpe 0.18）★ 突破策略大幅勝過均值回歸。**8 個實驗 24+ 次嘗試確認此為全域最優。**
...
- **EEM 技術面天花板已確認**：8 個實驗覆蓋均值回歸、突破、動量、RS、趨勢、政權過濾、出場優化、波動率過濾。EEM 的 EM 宏觀事件驅動特性限制純技術策略上限約 Sharpe 0.18-0.20。
<!-- AI_CONTEXT_END -->
