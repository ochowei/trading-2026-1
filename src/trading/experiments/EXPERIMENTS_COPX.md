...
**當前最佳：** COPX-002（20日回檔 10-20% + WR(10) ≤ -80 + 20天持倉，Part A Sharpe 0.34，Part B Sharpe 0.30）
**前最佳：** COPX-001（10日回檔 9-18% + WR(10) ≤ -80 + 15天持倉，Part A Sharpe 0.08，Part B Sharpe 0.36）
**滾動窗口分析摘要：** COPX-001 ✓✓ 雙漸變（ΔWR max 9.2pp，10/12 正報酬窗口）；COPX-002 待分析
...
- 出場參數：TP +3.5~5.0% / SL -4.5~-7.0% / 持倉 15~20 天
- 最佳組合：20日回檔 10-20% + WR-80 + TP +3.5% / SL -5.0% / 20天（WR 74.2%/72.7%，Sharpe 0.34/0.30）
...
- 均值回歸效果穩健，COPX-002 A/B Sharpe 比 1.13x（近乎完美平衡）
- A/B 訊號率比 1.13:1（COPX-002，優秀），WR 差距僅 1.5pp
...
COPX-001 (10日回檔 9-18% + WR(10) ≤ -80, 15天)
  ...
  └── COPX-002 (20日回檔 10-20% + WR(10) ≤ -80, 20天) ← 當前最佳
