...
**已掃描的參數空間：**
- 進場條件：回檔 8~10% + 上限 16~20% + WR(10) ≤ -80~-85 + RSI(2) < 10~15 + 2日跌幅 3~4% + ClosePos ≥ 40% + 60日回撤 15% + RSI(10) < 30 + SMA(50) 乖離 -6%
- 回檔回看：10日、20日
- 出場參數：TP +3.5~4.5% / SL -4.0~-5.0% / 持倉 15~20 天
- 冷卻期：10~12 天
