...
**當前最佳：** TSM-006（動量回調：ROC(20)≥10% + 5日回撤3-7% + Close>SMA(50)，TP+7%/SL-7%/20天）— Part A Sharpe 0.46/Part B 0.57，min(A,B) 0.46，A/B 訊號比 1.2:1
...
| TSM-006 | `tsm_006_momentum_pullback`    | 動量回調（ROC+短期回撤+SMA50）    | **最佳** |
