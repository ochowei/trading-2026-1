...
**當前最佳：** ★ **TSM-011 Att3**（Signal-Day Direction Filter on RS Momentum Pullback：TSM-008 完整框架 + **5 日報酬 ceiling <= +10.5%** rally exhaustion filter，TP+8%/SL-7%/25天/cd 10）★ **2026-05-02 新全域最優（11 次實驗、33+ 次嘗試）**
