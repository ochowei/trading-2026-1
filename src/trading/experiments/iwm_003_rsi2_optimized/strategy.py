...
from trading.experiments.iwm_003_rsi2_optimized.signal_detector import (
    IWMRsi2OptSignalDetector,
)
...
class IWMRsi2OptStrategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return IWMRsi2OptSignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, IWMRsi2OptConfig):
