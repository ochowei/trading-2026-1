...
from trading.experiments.eem_011_no_closepos_atr.signal_detector import (
    EEM011SignalDetector,
)
...
class EEM011Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return EEM011SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, EEM011Config):
            ...
            print("  收盤位置 (Close Position): 無 (Disabled)")
            print(
