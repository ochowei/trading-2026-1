"""
EEM-022: Global-Equity Macro-Context Confirmation Gate on Vol-Transition MR Strategy
...
from trading.experiments.eem_022_global_macro_context_mr.signal_detector import (
    EEM022SignalDetector,
)
...
class EEM022Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return EEM022SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, EEM022Config):
            ...
            print(
                ...
                "（EEM-022 核心：require 發達市場亦同步 drawdown）"
            )
