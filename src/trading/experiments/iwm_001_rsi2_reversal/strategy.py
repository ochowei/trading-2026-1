...
from trading.experiments.iwm_001_rsi2_reversal.signal_detector import (
    IWMRsi2SignalDetector,
)
...
class IWMRsi2Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return IWMRsi2SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, IWMRsi2Config):
