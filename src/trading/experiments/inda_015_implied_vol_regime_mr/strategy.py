"""
INDA-015: Forward-Looking Implied-Vol Regime-Gated Multi-Period
...
from trading.experiments.inda_015_implied_vol_regime_mr.signal_detector import (
    INDA015SignalDetector,
)
...
class INDA015Strategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return INDA015SignalDetector(create_default_config())

    def _print_strategy_params(self, config: ExperimentConfig) -> None:
        if isinstance(config, INDA015Config):
            print(
            ...
            print(
                ...
                "（INDA-015 核心創新：lesson #24 forward-looking implied-vol）"
            )
