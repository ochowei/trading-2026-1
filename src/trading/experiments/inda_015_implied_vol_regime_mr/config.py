"""
INDA Forward-Looking Implied-Vol Regime-Gated MR 配置 (INDA-015)
...
強度通道」。INDA-015 為該根因的合理下一步驗證：以 lesson #24 family
...
- INDA-015 為 lesson #24 family 首次應用於「單一國家 EM 股票 ETF」
...
========================================================================
結論：INDA-015 三次迭代全部 FAIL / REJECT，INDA-011 Att3（min 0.55）
...
@dataclass
class INDA015Config(ExperimentConfig):
    """INDA-015 Forward-Looking Implied-Vol Regime-Gated MR 參數"""
    ...
    # === INDA-015 新增：forward-looking implied-vol regime gate ===
...
def create_default_config() -> INDA015Config:
    """建立預設配置（Att3 nominal-best REJECT：^MOVE 3d floor >= -2.5）"""
    return INDA015Config(
        name="inda_015_implied_vol_regime_mr",
        experiment_id="INDA-015",
