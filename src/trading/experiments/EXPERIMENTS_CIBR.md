...
**當前最佳：** CIBR-007 Att1（BB 下軌均值回歸：BB(20,2.0) 下軌觸及 + WR(10)<=-80 + ClosePos>=40% + ATR(5)/ATR(20)>1.15）min(A,B) Sharpe 0.27（+17% vs CIBR-002 的 0.23）。統計自適應門檻（BB 下軌）優於固定回檔門檻，低波動期淺門檻+高波動期深門檻自動適應。7 次實驗、21 次嘗試。

**次佳：** CIBR-002 Att3（波動率自適應 MR：10日回檔>=4% + WR(10)<=-80 + ClosePos>=40% + ATR>1.15，min 0.23）
...
|------|----------|-----------------|----------|---------------|---------------|---------------|---------------|---------------|-----------------|
| 策略 | 回檔+WR | 波動率自適應 MR | BB Squeeze | RSI(2) | 動量強化 MR | 動量強化 MR | 20日回看 MR | RS 動量回調 | **BB 下軌 MR** |
| 進場框架 | pullback+WR | pullback+WR | BB Squeeze | RSI(2) | pullback+WR | pullback+WR | pullback+WR | RS+pullback | **BB lower** |
| BB 參數 | — | — | BB(20,2.0) | — | — | — | — | — | **BB(20,2.0)** |
| 回看窗口 | 10日 | 10日 | — | — | 10日 | 10日 | **20日** | 10日 | — |
| 回檔門檻 | 5% | 4% | — | — | 4% | 4% | **6%** | 2% | — |
| WR | WR(10)≤-80 | WR(10)≤-80 | — | — | WR(10)≤-80 | WR(10)≤-80 | **WR(14)≤-80** | — | WR(10)≤-80 |
| RSI(2) | — | — | — | <10 | — | — | — | — | — |
| ClosePos | — | ≥40% | — | ≥40% | ≥40% | ≥40% | ≥40% | — | ≥40% |
| ATR ratio | — | >1.15 | — | >1.15 | >1.15 | >1.15 | >1.15 | — | >1.15 |
| TP | +3.5% | +3.5% | +4.0% | +3.5% | +4.0% | +3.5% | +3.5% | +3.5% | +3.5% |
| SL | -4.0% | -4.0% | -4.0% | -4.0% | -4.0% | -4.5% | -4.0% | -4.0% | -4.0% |
| 持倉 | 18天 | 18天 | 20天 | 15天 | 15天 | 18天 | **15天** | 18天 | 18天 |
| 冷卻 | 8天 | 8天 | 10天 | 5天 | 8天 | 8天 | 8天 | 8天 | 8天 |
| Part A Sharpe | 0.11 | 0.23 | -0.20 | -0.19 | -0.00 | -0.05 | 0.18 | -0.22 | **0.27** |
| Part B Sharpe | 0.48 | 0.79 | -0.27 | 1.44 | 0.62 | 4.69 | 0.26 | -0.11 | **4.38** |
| min(A,B) | 0.11 | 0.23 | -0.27 | -0.19 | -0.00 | -0.05 | 0.18 | -0.22 | **0.27** |
| A/B 訊號頻率比 | 1.29:1 | 0.97:1 | 0.80:1 | 0.72:1 | 0.91:1 | 0.73:1 | **2.0:1** | **5.6:1** | 0.72:1 |
...
| CIBR-007 | `cibr_007_bb_lower_mr`         | BB(20,2.0) 下軌均值回歸（★新最佳，min 0.27）              | 已完成 |
...
CIBR-001 (回檔+WR 基礎版，Sharpe 0.11)
  ...
  └── CIBR-007 ★ (BB 下軌 MR，Sharpe 0.27，+17% vs CIBR-002)
        ├── Att1: BB(20,2.0)+WR+ClosePos+ATR（min 0.27）★ Final
