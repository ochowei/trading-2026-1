...
**當前最佳：** CIBR-002 Att3（波動率自適應均值回歸：10日回檔>=4% + WR(10)<=-80 + ClosePos>=40% + ATR(5)/ATR(20)>1.15）已確認全域最優（5 次實驗、15 次嘗試，含回檔+WR、波動率自適應 MR、BB Squeeze 突破、RSI(2)、動量強化 MR、20日回看窗口 MR 六大策略類型驗證）
...
| 參數 | CIBR-001 | CIBR-002 Att3 ★ | CIBR-003 | CIBR-004 Att1 | CIBR-004 Att2 | CIBR-004 Att3 | CIBR-005 Att1 |
|------|----------|-----------------|----------|---------------|---------------|---------------|---------------|
| 策略 | 回檔+WR | 波動率自適應 MR | BB Squeeze | RSI(2) | 動量強化 MR | 動量強化 MR | 20日回看 MR |
| 進場框架 | pullback+WR | pullback+WR | BB Squeeze | RSI(2) | pullback+WR | pullback+WR | pullback+WR |
| 回看窗口 | 10日 | 10日 | — | — | 10日 | 10日 | **20日** |
| 回檔門檻 | 5% | 4% | — | — | 4% | 4% | **6%** |
...
| 2日急跌 | — | — | — | ≤-2.0% | ≤-1.5% | ≤-2.0% | — |
| TP | +3.5% | +3.5% | +4.0% | +3.5% | +4.0% | +3.5% | +3.5% |
| SL | -4.0% | -4.0% | -4.0% | -4.0% | -4.0% | -4.5% | -4.0% |
| 持倉 | 18天 | 18天 | 20天 | 15天 | 15天 | 18天 | **15天** |
| 冷卻 | 8天 | 8天 | 10天 | 5天 | 8天 | 8天 | 8天 |
| Part A Sharpe | 0.11 | **0.23** | -0.20 | -0.19 | -0.00 | -0.05 | 0.18 |
| Part B Sharpe | 0.48 | **0.79** | -0.27 | 1.44 | 0.62 | 4.69 | 0.26 |
| min(A,B) | 0.11 | **0.23** | -0.27 | -0.19 | -0.00 | -0.05 | 0.18 |
| A/B 訊號頻率比 | 1.29:1 | 0.97:1 | 0.80:1 | 0.72:1 | 0.91:1 | 0.73:1 | **2.0:1** |
...
- 趨勢動量回檔（lesson #25 板塊 ETF 動量無效 + lesson #5 趨勢+均值回歸=災難）
