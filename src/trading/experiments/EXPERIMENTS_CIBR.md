...
**當前最佳：** CIBR-002 Att3（波動率自適應均值回歸：10日回檔>=4% + WR(10)<=-80 + ClosePos>=40% + ATR(5)/ATR(20)>1.15）已確認全域最優（4 次實驗、12 次嘗試，含回檔+WR、波動率自適應 MR、BB Squeeze 突破、RSI(2)、動量強化 MR 五大策略類型驗證）
...
| 參數 | CIBR-001 | CIBR-002 Att3 ★ | CIBR-003 | CIBR-004 Att1 | CIBR-004 Att2 | CIBR-004 Att3 |
|------|----------|-----------------|----------|---------------|---------------|---------------|
| 策略 | 回檔+WR | 波動率自適應 MR | BB Squeeze | RSI(2) | 動量強化 MR | 動量強化 MR |
| 進場框架 | pullback+WR | pullback+WR | BB Squeeze | RSI(2) | pullback+WR | pullback+WR |
| 回檔門檻 | 5% | 4% | — | — | 4% | 4% |
| WR(10) | ≤-80 | ≤-80 | — | — | ≤-80 | ≤-80 |
| RSI(2) | — | — | — | <10 | — | — |
| ClosePos | — | ≥40% | — | ≥40% | ≥40% | ≥40% |
| ATR ratio | — | >1.15 | — | >1.15 | >1.15 | >1.15 |
| 2日急跌 | — | — | — | ≤-2.0% | ≤-1.5% | ≤-2.0% |
| TP | +3.5% | +3.5% | +4.0% | +3.5% | +4.0% | +3.5% |
| SL | -4.0% | -4.0% | -4.0% | -4.0% | -4.0% | -4.5% |
| 持倉 | 18天 | 18天 | 20天 | 15天 | 15天 | 18天 |
| 冷卻 | 8天 | 8天 | 10天 | 5天 | 8天 | 8天 |
| Part A Sharpe | 0.11 | **0.23** | -0.20 | -0.19 | -0.00 | -0.05 |
| Part B Sharpe | 0.48 | **0.79** | -0.27 | 1.44 | 0.62 | 4.69 |
| min(A,B) | 0.11 | **0.23** | -0.27 | -0.19 | -0.00 | -0.05 |
| A/B 訊號頻率比 | 1.29:1 | 0.97:1 | 0.80:1 | 0.72:1 | 0.91:1 | 0.73:1 |
