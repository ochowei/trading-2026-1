"""
TSLA-018: TSLA-USD(UUP) Direction Regime-Gated BB Squeeze Breakout 策略
...
from trading.experiments.tsla_018_usd_regime_breakout.config import (
    TSLA018Config,
    create_default_config,
)
from trading.experiments.tsla_018_usd_regime_breakout.signal_detector import (
    TSLA018USDRegimeBreakoutDetector,
)


class TSLA018USDRegimeBreakoutStrategy(ExecutionModelStrategy):
    ...
    def create_detector(self) -> BaseSignalDetector:
        return TSLA018USDRegimeBreakoutDetector(create_default_config())
