"""FXI ATR-band robustness challenge with a tighter 1.30 ceiling."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion/atr-ceiling-1p30-robustness",
    result_name="fxi-atr-band-mean-reversion--atr-ceiling-1p30-robustness",
    family="fxi-atr-band-mean-reversion",
    hypothesis="The FXI candidate remains viable with an ATR-ratio ceiling of 1.30.",
