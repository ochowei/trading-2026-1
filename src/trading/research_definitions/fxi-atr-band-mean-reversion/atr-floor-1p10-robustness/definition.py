"""FXI ATR-band robustness challenge with a stricter 1.10 floor."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion/atr-floor-1p10-robustness",
    result_name="fxi-atr-band-mean-reversion--atr-floor-1p10-robustness",
