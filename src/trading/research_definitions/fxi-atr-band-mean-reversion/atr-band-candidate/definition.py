"""Sole FXI ATR-band mean-reversion selection candidate."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion/atr-band-candidate",
    result_name="fxi-atr-band-mean-reversion--atr-band-candidate",
    family="fxi-atr-band-mean-reversion",
    hypothesis="A bounded FXI volatility-acceleration state improves next-open reversals.",
