"""FXI ATR-band robustness challenge with entry delayed by one extra session."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion/delay-one-session-robustness",
    result_name="fxi-atr-band-mean-reversion--delay-one-session-robustness",
