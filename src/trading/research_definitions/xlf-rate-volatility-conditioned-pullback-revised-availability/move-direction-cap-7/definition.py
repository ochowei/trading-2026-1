"""Revised-availability XLF pullback trial with a seven-point MOVE direction cap."""
...
DEFINITION = RateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback-revised-availability/move-direction-cap-7",
    result_name=(
        "xlf-rate-volatility-conditioned-pullback-revised-availability--move-direction-cap-7"
    ),
