"""Publication-lag-safe XLF pullback trial with a five-point MOVE direction cap."""
...
DEFINITION = RateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback-publication-lag-safe/move-direction-cap-5",
    result_name=(
        "xlf-rate-volatility-conditioned-pullback-publication-lag-safe--move-direction-cap-5"
    ),
