"""Distinct XLF pullback baseline without a rate-volatility gate."""
...
DEFINITION = RateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback/ungated-pullback-baseline",
    result_name="xlf-rate-volatility-conditioned-pullback--ungated-pullback-baseline",
    family="xlf-rate-volatility-conditioned-pullback",
    hypothesis="An ungated XLF pullback is the distinct simple family comparator.",
