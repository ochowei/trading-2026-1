"""XLF pullback trial with a three-point MOVE direction cap."""
...
DEFINITION = RateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback/move-direction-cap-3",
    result_name="xlf-rate-volatility-conditioned-pullback--move-direction-cap-3",
