"""FXI no-ClosePos robustness challenge with a stricter 1.10 ATR floor."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity=("fxi-no-closepos-atr-floor-mean-reversion/no-closepos-atr-floor-1p10-robustness"),
    result_name=("fxi-no-closepos-atr-floor-mean-reversion--no-closepos-atr-floor-1p10-robustness"),
    family="fxi-no-closepos-atr-floor-mean-reversion",
    hypothesis="The no-ClosePos FXI candidate remains viable with an ATR floor of 1.10.",
