"""FXI no-ClosePos robustness challenge with entry delayed one extra session."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity=("fxi-no-closepos-atr-floor-mean-reversion/no-closepos-delay-one-session-robustness"),
    result_name=(
        "fxi-no-closepos-atr-floor-mean-reversion--no-closepos-delay-one-session-robustness"
    ),
    family="fxi-no-closepos-atr-floor-mean-reversion",
    hypothesis="The no-ClosePos FXI candidate remains viable with entry delayed one session.",
