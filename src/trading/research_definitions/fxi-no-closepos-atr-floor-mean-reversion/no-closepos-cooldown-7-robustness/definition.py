"""FXI no-ClosePos robustness challenge with a seven-session cooldown."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity=("fxi-no-closepos-atr-floor-mean-reversion/no-closepos-cooldown-7-robustness"),
    result_name=("fxi-no-closepos-atr-floor-mean-reversion--no-closepos-cooldown-7-robustness"),
    family="fxi-no-closepos-atr-floor-mean-reversion",
    hypothesis="The no-ClosePos FXI candidate remains viable with a seven-session cooldown.",
