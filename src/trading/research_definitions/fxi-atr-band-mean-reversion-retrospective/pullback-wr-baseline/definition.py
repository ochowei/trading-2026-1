"""Retrospective distinct FXI pullback and Williams-%R family baseline."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion-retrospective/pullback-wr-baseline",
    result_name="fxi-atr-band-mean-reversion-retrospective--pullback-wr-baseline",
    family="fxi-atr-band-mean-reversion-retrospective",
    hypothesis="A pullback and Williams-%R rule is the retrospective family baseline.",
