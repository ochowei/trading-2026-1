"""Retrospective FXI ATR-band challenge with an eighteen-session holding period."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion-retrospective/hold-18-robustness",
    result_name="fxi-atr-band-mean-reversion-retrospective--hold-18-robustness",
    family="fxi-atr-band-mean-reversion-retrospective",
    hypothesis="The retrospective candidate remains viable with an eighteen-session holding.",
