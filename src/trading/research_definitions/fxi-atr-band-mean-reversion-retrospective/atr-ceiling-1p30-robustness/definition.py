"""Retrospective FXI ATR-band challenge with a tighter 1.30 ceiling."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-band-mean-reversion-retrospective/atr-ceiling-1p30-robustness",
    result_name=("fxi-atr-band-mean-reversion-retrospective--atr-ceiling-1p30-robustness"),
    family="fxi-atr-band-mean-reversion-retrospective",
    hypothesis="The retrospective candidate remains viable with an ATR ceiling of 1.30.",
