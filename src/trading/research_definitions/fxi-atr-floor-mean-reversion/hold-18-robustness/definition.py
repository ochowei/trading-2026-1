"""FXI ATR-floor robustness challenge with an eighteen-session holding period."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-floor-mean-reversion/hold-18-robustness",
    result_name="fxi-atr-floor-mean-reversion--hold-18-robustness",
