"""FXI ATR-floor robustness challenge with entry delayed by one extra session."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-floor-mean-reversion/delay-one-session-robustness",
    result_name="fxi-atr-floor-mean-reversion--delay-one-session-robustness",
    family="fxi-atr-floor-mean-reversion",
    hypothesis="The FXI candidate remains viable when entry is delayed one additional session.",
