"""Sole FXI ATR-floor mean-reversion selection candidate."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-floor-mean-reversion/atr-floor-candidate",
    result_name="fxi-atr-floor-mean-reversion--atr-floor-candidate",
    family="fxi-atr-floor-mean-reversion",
    hypothesis="An open-ended FXI volatility-acceleration floor supports next-open reversals.",
