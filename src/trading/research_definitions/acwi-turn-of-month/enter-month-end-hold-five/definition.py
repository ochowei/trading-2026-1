"""ACWI turn-of-month candidate entering at the M0 open."""
...
DEFINITION = MonthlyCalendarResearchDefinition(
    identity="acwi-turn-of-month/enter-month-end-hold-five",
    result_name="acwi-turn-of-month--enter-month-end-hold-five",
    family="acwi-turn-of-month",
    hypothesis="ACWI has a net turn-of-month cash-flow effect around the M0 open.",
