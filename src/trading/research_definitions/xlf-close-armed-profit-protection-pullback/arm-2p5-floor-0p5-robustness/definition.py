"""Higher-arm robustness definition for the XLF profit-protection study."""
...
DEFINITION = ProfitProtectionPullbackResearchDefinition(
    identity="xlf-close-armed-profit-protection-pullback/arm-2p5-floor-0p5-robustness",
    result_name="xlf-close-armed-profit-protection-pullback--arm-2p5-floor-0p5-robustness",
    family="xlf-close-armed-profit-protection-pullback",
    hypothesis="A higher arming threshold must not reverse the fixed protection claim.",
