"""Gap-safe XLF pullback trial with a five-point MOVE direction cap."""
...
DEFINITION = GapSafeRateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback-gap-safe/move-direction-cap-5",
    result_name="xlf-rate-volatility-conditioned-pullback-gap-safe--move-direction-cap-5",
