"""Gap-safe XLF pullback trial with a three-point MOVE direction cap."""
...
DEFINITION = GapSafeRateVolatilityPullbackResearchDefinition(
    identity="xlf-rate-volatility-conditioned-pullback-gap-safe/move-direction-cap-3",
    result_name="xlf-rate-volatility-conditioned-pullback-gap-safe--move-direction-cap-3",
