"""SCHD three-session down-streak mean-reversion trial."""
...
DEFINITION = DailyBarResearchDefinition(
    identity="schd-down-streak-reversion/three-down",
    result_name="schd-down-streak-reversion--three-down",
