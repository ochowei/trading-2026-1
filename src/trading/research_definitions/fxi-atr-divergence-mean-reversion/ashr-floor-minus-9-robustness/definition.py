"""FXI candidate robustness challenge with a looser -9% ASHR floor."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-divergence-mean-reversion/ashr-floor-minus-9-robustness",
    result_name="fxi-atr-divergence-mean-reversion--ashr-floor-minus-9-robustness",
    family="fxi-atr-divergence-mean-reversion",
    hypothesis="The FXI candidate remains viable with a looser -9% ASHR divergence floor.",
