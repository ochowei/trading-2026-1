"""FXI candidate robustness challenge with a stricter -7% ASHR floor."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-divergence-mean-reversion/ashr-floor-minus-7-robustness",
    result_name="fxi-atr-divergence-mean-reversion--ashr-floor-minus-7-robustness",
    family="fxi-atr-divergence-mean-reversion",
    hypothesis="The FXI candidate remains viable with a stricter -7% ASHR divergence floor.",
