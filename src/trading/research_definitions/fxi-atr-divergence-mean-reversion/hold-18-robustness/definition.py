"""FXI candidate robustness challenge with an eighteen-session holding period."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-divergence-mean-reversion/hold-18-robustness",
    result_name="fxi-atr-divergence-mean-reversion--hold-18-robustness",
