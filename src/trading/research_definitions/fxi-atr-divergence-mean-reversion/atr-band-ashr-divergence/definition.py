"""Sole FXI ATR-band and ASHR-divergence selection candidate."""
...
DEFINITION = FXIMeanReversionResearchDefinition(
    identity="fxi-atr-divergence-mean-reversion/atr-band-ashr-divergence",
    result_name="fxi-atr-divergence-mean-reversion--atr-band-ashr-divergence",
    family="fxi-atr-divergence-mean-reversion",
    hypothesis="Bounded FXI volatility acceleration and ASHR divergence improve reversals.",
